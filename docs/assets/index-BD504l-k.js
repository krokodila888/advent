...
<p><strong>Совет:</strong> Попробуй несколько нейросетей — у каждой своя интерпретация.</p>
  ...
  `,zebra_message:`
    ...
    <p>Сегодня мы все вместе в Смоленске! Кофе? Загадка (узнаем на месте, я не записала), но если вдруг в конверте окажется болотная тина, то можно добыть из меня нормальный дрип.</p>
    
    <p>Неронки генерят про Смоленск уже знакомую нам скучную пургу (Наполеон - ВОВ - храм-долгострой), но я попыталась выдавить из них что-нибудь сверх этого.</p>
    
    <h3>Башня Веселуха и "Формула любви" 🎬🏰</h3>
    
    <p><strong>Факт:</strong> Легенда о смоленской башне Веселуха вдохновила Алексея Толстого написать рассказ «Граф Калиостро». Потом Марк Захаров снял по нему фильм <strong>«Формула любви»!</strong></p>
    ...
    <ul>
      ...
      <li><strong>Версия 2 (мрачная):</strong> В башне замуровали живую девушку при строительстве (жертва духам для прочности стены)</li>
      <li>По ночам из башни слышался <strong>женский плач и смех</strong> — то ли призрак, то ли ветер в подземельях</li>
      <li>Под башней была тайная галерея — «слух» (подземный ход для шпионажа)</li>
      <li>Именно эта история попала в "Формулу любви"!</li>
    </ul>
    
    <p><strong>Итог:</strong> Если смотрела "Формулу любви" — знай, что всё началось со смоленской башни! 🎭</p>

    
    <h3>"Паук" — надпись под куполом 🕷️💔</h3>
    
    <p><strong>Загадка Заалтарной башни:</strong></p>
    <ul>
      <li>Под самым куполом башни (на огромной высоте!) написано слово: <strong>"ПАУК"</strong></li>
      <li>Что это? Прозвище экстремала, который любил лазить по башням без страховки</li>
      <li>Однажды он забрался на вершину, разжал пальцы и упал камнем вниз</li>
      <li>Разбился насмерть</li>
      <li>Говорят — из-за несчастной любви 💔</li>
      <li>Надпись осталась как напоминание</li>
    </ul>
    
    <p><em>Романтично и жутко одновременно. Смоленск такой.</em></p>
    
    <h3>Морис Маркин — смоленский король такси 🚖👑</h3>
    
    <p><strong>История:</strong></p>
    <ul>
      <li>Родился в Смоленске в 1893 году в бедной семье</li>
      <li>1912 год: уехал в США <strong>без денег и без знания языка!</strong></li>
      <li>Работал портным в Чикаго</li>
      <li>1921 год: скупил несколько компаний и создал <strong>Checker Cab Manufacturing Co.</strong></li>
      <li>Стал <strong>лидером рынка такси в США!</strong></li>
      <li>1929 год: выкупил Yellow Cab Company у Джона Херца</li>
    ...
    <ul>
      ...
      <li>Строить начали ещё при Иване Грозном (XVI век!)</li>
      <li>При строительстве крепости (1595-1602) под башнями делали «слухи» — подземные галереи</li>
      <li><strong>1609-1611:</strong> Первые в истории <strong>подземные бои!</strong> (во время осады поляками)</li>
      <li>Схемы подземелий утеряны — никто не знает точно, что где!</li>
      <li>При стройке иногда находят новые ходы</li>
      <li>2015 год: нашли ход от дома до церкви (300 метров!), внутри — бутылки и монеты XIX века</li>
    </ul>
    
    <p><strong>Зачем подземелья:</strong></p>
    <ul>
      <li><strong>Военные цели:</strong> шпионаж, побег при осаде, тайные проходы между укреплениями</li>
      <li><strong>Контрабанда:</strong> Смоленск — торговый город → купцы прятали товары от налогов</li>
      <li><strong>Казематы:</strong> В Лопатинском саду держали заключённых (в том числе Кочубея и Искру — тех, кто донёс Петру I об измене Мазепы!)</li>
    </ul>
    
    <p><strong>Страшилки:</strong></p>
    <ul>
      <li>В здании сельхозакадемии (XVIII век) нашли <strong>скелеты в кандалах</strong> и железные кольца с цепями</li>
      <li>Там были пыточные камеры!</li>
      <li>Диггеры пробираются в подземелья, но опасно — обвалы!</li>
    </ul>
    
    <p><em>Смоленск: сверху — крепость, снизу — лабиринт. Идеально для контрабандистов!</em> 😄</p>
    
    <hr>
    
    <h3>Контрабанда в России — краткий экскурс 🚂📦</h3>
    
    <p><strong>Почему Смоленск:</strong></p>
    <ul>
      <li>На западной границе → первый город на пути в Европу</li>
      <li>Торговый город на пути «из варяг в греки»</li>
      <li>Подземелья → идеальные тайники!</li>
      <li><strong>1921 год:</strong> В Смоленске создали одну из первых <strong>окружных комиссий по борьбе с контрабандой!</strong></li>
    </ul>
    
    <p><strong>1872 год — "Сборник ухищрений и уловок":</strong></p>
    <ul>
      <li>Департамент таможенных сборов собрал все способы контрабанды в один сборник!</li>
      <li>Для обучения таможенников</li>
      <li><strong>Что прятали:</strong> в паровозах (двойное дно!), между дровами и углём, в воде (герметично!), в двойных стенках вагонов, под обивкой, в матрасах...</li>
      <li>Читаешь и думаешь: "А граница вообще закрыта была?!" 😄</li>
    </ul>
    
    <p><strong>Что везли через Смоленск:</strong></p>
    <ul>
      <li><strong>XIX век:</strong> лён (из России), соль, сахарин, спирт, кожа (в Россию)</li>
      <li><strong>СССР (1920-е):</strong> промтовары, продукты</li>
      <li><strong>Сейчас:</strong> сигареты (11 миллионов пачек за год задерживают!), одежда, техника</li>
    </ul>
    
    <p><em>Контрабанда — вечная борьба таможенников и находчивости. Смоленск в эпицентре! 🚂📦</em></p>
    ...
    <p><em>Идём по барам, поём (что-то), пьём (в меру), веселимся! Духи предков одобряют! 👻🍻</em></p>
    
    <h3>Смоленский кофе — загадка дня ☕❓</h3>
    
    <p><strong>Что это будет:</strong></p>
    <ul>
      <li>Местный кофе из смоленской кофейни?</li>
      <li>Кофе в баре во время колядок?</li>
      <li>Что-то ещё?</li>
      <li><strong>Загадка!</strong> Узнаем на месте!</li>
      <li><strong>Важно:</strong> Если хочешь кофе — потыкай меня, у меня с собой! ☕😄</li>
    </ul>
