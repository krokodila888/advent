(function(){const j=document.createElement("link").relList;if(j&&j.supports&&j.supports("modulepreload"))return;for(const M of document.querySelectorAll('link[rel="modulepreload"]'))p(M);new MutationObserver(M=>{for(const x of M)if(x.type==="childList")for(const X of x.addedNodes)X.tagName==="LINK"&&X.rel==="modulepreload"&&p(X)}).observe(document,{childList:!0,subtree:!0});function O(M){const x={};return M.integrity&&(x.integrity=M.integrity),M.referrerPolicy&&(x.referrerPolicy=M.referrerPolicy),M.crossOrigin==="use-credentials"?x.credentials="include":M.crossOrigin==="anonymous"?x.credentials="omit":x.credentials="same-origin",x}function p(M){if(M.ep)return;M.ep=!0;const x=O(M);fetch(M.href,x)}})();var oo={exports:{}},_e={};var bf;function rm(){if(bf)return _e;bf=1;var v=Symbol.for("react.transitional.element"),j=Symbol.for("react.fragment");function O(p,M,x){var X=null;if(x!==void 0&&(X=""+x),M.key!==void 0&&(X=""+M.key),"key"in M){x={};for(var P in M)P!=="key"&&(x[P]=M[P])}else x=M;return M=x.ref,{$$typeof:v,type:p,key:X,ref:M!==void 0?M:null,props:x}}return _e.Fragment=j,_e.jsx=O,_e.jsxs=O,_e}var Sf;function cm(){return Sf||(Sf=1,oo.exports=rm()),oo.exports}var d=cm(),ro={exports:{}},L={};var zf;function gm(){if(zf)return L;zf=1;var v=Symbol.for("react.transitional.element"),j=Symbol.for("react.portal"),O=Symbol.for("react.fragment"),p=Symbol.for("react.strict_mode"),M=Symbol.for("react.profiler"),x=Symbol.for("react.consumer"),X=Symbol.for("react.context"),P=Symbol.for("react.forward_ref"),U=Symbol.for("react.suspense"),T=Symbol.for("react.memo"),C=Symbol.for("react.lazy"),N=Symbol.for("react.activity"),$=Symbol.iterator;function yl(g){return g===null||typeof g!="object"?null:(g=$&&g[$]||g["@@iterator"],typeof g=="function"?g:null)}var vl={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},_l=Object.assign,Ul={};function bl(g,w,D){this.props=g,this.context=w,this.refs=Ul,this.updater=D||vl}bl.prototype.isReactComponent={},bl.prototype.setState=function(g,w){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,g,w,"setState")},bl.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function Ml(){}Ml.prototype=bl.prototype;function ul(g,w,D){this.props=g,this.context=w,this.refs=Ul,this.updater=D||vl}var Tl=ul.prototype=new Ml;Tl.constructor=ul,_l(Tl,bl.prototype),Tl.isPureReactComponent=!0;var Vl=Array.isArray;function Sl(){}var K={H:null,A:null,T:null,S:null},Hl=Object.prototype.hasOwnProperty;function Jl(g,w,D){var H=D.ref;return{$$typeof:v,type:g,key:w,ref:H!==void 0?H:null,props:D}}function Ft(g,w){return Jl(g.type,w,g.props)}function pt(g){return typeof g=="object"&&g!==null&&g.$$typeof===v}function kl(g){var w={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(D){return w[D]})}var wn=/\/+/g;function xt(g,w){return typeof g=="object"&&g!==null&&g.key!=null?kl(""+g.key):w.toString(36)}function At(g){switch(g.status){case"fulfilled":return g.value;case"rejected":throw g.reason;default:switch(typeof g.status=="string"?g.then(Sl,Sl):(g.status="pending",g.then(function(w){g.status==="pending"&&(g.status="fulfilled",g.value=w)},function(w){g.status==="pending"&&(g.status="rejected",g.reason=w)})),g.status){case"fulfilled":return g.value;case"rejected":throw g.reason}}throw g}function z(g,w,D,H,Q){var J=typeof g;(J==="undefined"||J==="boolean")&&(g=null);var el=!1;if(g===null)el=!0;else switch(J){case"bigint":case"string":case"number":el=!0;break;case"object":switch(g.$$typeof){case v:case j:el=!0;break;case C:return el=g._init,z(el(g._payload),w,D,H,Q)}}if(el)return Q=Q(g),el=H===""?"."+xt(g,0):H,Vl(Q)?(D="",el!=null&&(D=el.replace(wn,"$&/")+"/"),z(Q,w,D,"",function(Ci){return Ci})):Q!=null&&(pt(Q)&&(Q=Ft(Q,D+(Q.key==null||g&&g.key===Q.key?"":(""+Q.key).replace(wn,"$&/")+"/")+el)),w.push(Q)),1;el=0;var $l=H===""?".":H+":";if(Vl(g))for(var jl=0;jl<g.length;jl++)H=g[jl],J=$l+xt(H,jl),el+=z(H,w,D,J,Q);else if(jl=yl(g),typeof jl=="function")for(g=jl.call(g),jl=0;!(H=g.next()).done;)H=H.value,J=$l+xt(H,jl++),el+=z(H,w,D,J,Q);else if(J==="object"){if(typeof g.then=="function")return z(At(g),w,D,H,Q);throw w=String(g),Error("Objects are not valid as a React child (found: "+(w==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":w)+"). If you meant to render a collection of children, use an array instead.")}return el}function E(g,w,D){if(g==null)return g;var H=[],Q=0;return z(g,H,"","",function(J){return w.call(D,J,Q++)}),H}function G(g){if(g._status===-1){var w=g._result;w=w(),w.then(function(D){(g._status===0||g._status===-1)&&(g._status=1,g._result=D)},function(D){(g._status===0||g._status===-1)&&(g._status=2,g._result=D)}),g._status===-1&&(g._status=0,g._result=w)}if(g._status===1)return g._result.default;throw g._result}var ol=typeof reportError=="function"?reportError:function(g){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var w=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof g=="object"&&g!==null&&typeof g.message=="string"?String(g.message):String(g),error:g});if(!window.dispatchEvent(w))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",g);return}console.error(g)},fl={map:E,forEach:function(g,w,D){E(g,function(){w.apply(this,arguments)},D)},count:function(g){var w=0;return E(g,function(){w++}),w},toArray:function(g){return E(g,function(w){return w})||[]},only:function(g){if(!pt(g))throw Error("React.Children.only expected to receive a single React element child.");return g}};return L.Activity=N,L.Children=fl,L.Component=bl,L.Fragment=O,L.Profiler=M,L.PureComponent=ul,L.StrictMode=p,L.Suspense=U,L.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=K,L.__COMPILER_RUNTIME={__proto__:null,c:function(g){return K.H.useMemoCache(g)}},L.cache=function(g){return function(){return g.apply(null,arguments)}},L.cacheSignal=function(){return null},L.cloneElement=function(g,w,D){if(g==null)throw Error("The argument must be a React element, but you passed "+g+".");var H=_l({},g.props),Q=g.key;if(w!=null)for(J in w.key!==void 0&&(Q=""+w.key),w)!Hl.call(w,J)||J==="key"||J==="__self"||J==="__source"||J==="ref"&&w.ref===void 0||(H[J]=w[J]);var J=arguments.length-2;if(J===1)H.children=D;else if(1<J){for(var el=Array(J),$l=0;$l<J;$l++)el[$l]=arguments[$l+2];H.children=el}return Jl(g.type,Q,H)},L.createContext=function(g){return g={$$typeof:X,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider=g,g.Consumer={$$typeof:x,_context:g},g},L.createElement=function(g,w,D){var H,Q={},J=null;if(w!=null)for(H in w.key!==void 0&&(J=""+w.key),w)Hl.call(w,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(Q[H]=w[H]);var el=arguments.length-2;if(el===1)Q.children=D;else if(1<el){for(var $l=Array(el),jl=0;jl<el;jl++)$l[jl]=arguments[jl+2];Q.children=$l}if(g&&g.defaultProps)for(H in el=g.defaultProps,el)Q[H]===void 0&&(Q[H]=el[H]);return Jl(g,J,Q)},L.createRef=function(){return{current:null}},L.forwardRef=function(g){return{$$typeof:P,render:g}},L.isValidElement=pt,L.lazy=function(g){return{$$typeof:C,_payload:{_status:-1,_result:g},_init:G}},L.memo=function(g,w){return{$$typeof:T,type:g,compare:w===void 0?null:w}},L.startTransition=function(g){var w=K.T,D={};K.T=D;try{var H=g(),Q=K.S;Q!==null&&Q(D,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(Sl,ol)}catch(J){ol(J)}finally{w!==null&&D.types!==null&&(w.types=D.types),K.T=w}},L.unstable_useCacheRefresh=function(){return K.H.useCacheRefresh()},L.use=function(g){return K.H.use(g)},L.useActionState=function(g,w,D){return K.H.useActionState(g,w,D)},L.useCallback=function(g,w){return K.H.useCallback(g,w)},L.useContext=function(g){return K.H.useContext(g)},L.useDebugValue=function(){},L.useDeferredValue=function(g,w){return K.H.useDeferredValue(g,w)},L.useEffect=function(g,w){return K.H.useEffect(g,w)},L.useEffectEvent=function(g){return K.H.useEffectEvent(g)},L.useId=function(){return K.H.useId()},L.useImperativeHandle=function(g,w,D){return K.H.useImperativeHandle(g,w,D)},L.useInsertionEffect=function(g,w){return K.H.useInsertionEffect(g,w)},L.useLayoutEffect=function(g,w){return K.H.useLayoutEffect(g,w)},L.useMemo=function(g,w){return K.H.useMemo(g,w)},L.useOptimistic=function(g,w){return K.H.useOptimistic(g,w)},L.useReducer=function(g,w,D){return K.H.useReducer(g,w,D)},L.useRef=function(g){return K.H.useRef(g)},L.useState=function(g){return K.H.useState(g)},L.useSyncExternalStore=function(g,w,D){return K.H.useSyncExternalStore(g,w,D)},L.useTransition=function(){return K.H.useTransition()},L.version="19.2.3",L}var _f;function ho(){return _f||(_f=1,ro.exports=gm()),ro.exports}var zl=ho(),co={exports:{}},Te={},go={exports:{}},fo={};var Tf;function fm(){return Tf||(Tf=1,(function(v){function j(z,E){var G=z.length;z.push(E);l:for(;0<G;){var ol=G-1>>>1,fl=z[ol];if(0<M(fl,E))z[ol]=E,z[G]=fl,G=ol;else break l}}function O(z){return z.length===0?null:z[0]}function p(z){if(z.length===0)return null;var E=z[0],G=z.pop();if(G!==E){z[0]=G;l:for(var ol=0,fl=z.length,g=fl>>>1;ol<g;){var w=2*(ol+1)-1,D=z[w],H=w+1,Q=z[H];if(0>M(D,G))H<fl&&0>M(Q,D)?(z[ol]=Q,z[H]=G,ol=H):(z[ol]=D,z[w]=G,ol=w);else if(H<fl&&0>M(Q,G))z[ol]=Q,z[H]=G,ol=H;else break l}}return E}function M(z,E){var G=z.sortIndex-E.sortIndex;return G!==0?G:z.id-E.id}if(v.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var x=performance;v.unstable_now=function(){return x.now()}}else{var X=Date,P=X.now();v.unstable_now=function(){return X.now()-P}}var U=[],T=[],C=1,N=null,$=3,yl=!1,vl=!1,_l=!1,Ul=!1,bl=typeof setTimeout=="function"?setTimeout:null,Ml=typeof clearTimeout=="function"?clearTimeout:null,ul=typeof setImmediate<"u"?setImmediate:null;function Tl(z){for(var E=O(T);E!==null;){if(E.callback===null)p(T);else if(E.startTime<=z)p(T),E.sortIndex=E.expirationTime,j(U,E);else break;E=O(T)}}function Vl(z){if(_l=!1,Tl(z),!vl)if(O(U)!==null)vl=!0,Sl||(Sl=!0,kl());else{var E=O(T);E!==null&&At(Vl,E.startTime-z)}}var Sl=!1,K=-1,Hl=5,Jl=-1;function Ft(){return Ul?!0:!(v.unstable_now()-Jl<Hl)}function pt(){if(Ul=!1,Sl){var z=v.unstable_now();Jl=z;var E=!0;try{l:{vl=!1,_l&&(_l=!1,Ml(K),K=-1),yl=!0;var G=$;try{t:{for(Tl(z),N=O(U);N!==null&&!(N.expirationTime>z&&Ft());){var ol=N.callback;if(typeof ol=="function"){N.callback=null,$=N.priorityLevel;var fl=ol(N.expirationTime<=z);if(z=v.unstable_now(),typeof fl=="function"){N.callback=fl,Tl(z),E=!0;break t}N===O(U)&&p(U),Tl(z)}else p(U);N=O(U)}if(N!==null)E=!0;else{var g=O(T);g!==null&&At(Vl,g.startTime-z),E=!1}}break l}finally{N=null,$=G,yl=!1}E=void 0}}finally{E?kl():Sl=!1}}}var kl;if(typeof ul=="function")kl=function(){ul(pt)};else if(typeof MessageChannel<"u"){var wn=new MessageChannel,xt=wn.port2;wn.port1.onmessage=pt,kl=function(){xt.postMessage(null)}}else kl=function(){bl(pt,0)};function At(z,E){K=bl(function(){z(v.unstable_now())},E)}v.unstable_IdlePriority=5,v.unstable_ImmediatePriority=1,v.unstable_LowPriority=4,v.unstable_NormalPriority=3,v.unstable_Profiling=null,v.unstable_UserBlockingPriority=2,v.unstable_cancelCallback=function(z){z.callback=null},v.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Hl=0<z?Math.floor(1e3/z):5},v.unstable_getCurrentPriorityLevel=function(){return $},v.unstable_next=function(z){switch($){case 1:case 2:case 3:var E=3;break;default:E=$}var G=$;$=E;try{return z()}finally{$=G}},v.unstable_requestPaint=function(){Ul=!0},v.unstable_runWithPriority=function(z,E){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var G=$;$=z;try{return E()}finally{$=G}},v.unstable_scheduleCallback=function(z,E,G){var ol=v.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?ol+G:ol):G=ol,z){case 1:var fl=-1;break;case 2:fl=250;break;case 5:fl=1073741823;break;case 4:fl=1e4;break;default:fl=5e3}return fl=G+fl,z={id:C++,callback:E,priorityLevel:z,startTime:G,expirationTime:fl,sortIndex:-1},G>ol?(z.sortIndex=G,j(T,z),O(U)===null&&z===O(T)&&(_l?(Ml(K),K=-1):_l=!0,At(Vl,G-ol))):(z.sortIndex=fl,j(U,z),vl||yl||(vl=!0,Sl||(Sl=!0,kl()))),z},v.unstable_shouldYield=Ft,v.unstable_wrapCallback=function(z){var E=$;return function(){var G=$;$=E;try{return z.apply(this,arguments)}finally{$=G}}}})(fo)),fo}var Af;function pm(){return Af||(Af=1,go.exports=fm()),go.exports}var po={exports:{}},Zl={};var wf;function dm(){if(wf)return Zl;wf=1;var v=ho();function j(U){var T="https://react.dev/errors/"+U;if(1<arguments.length){T+="?args[]="+encodeURIComponent(arguments[1]);for(var C=2;C<arguments.length;C++)T+="&args[]="+encodeURIComponent(arguments[C])}return"Minified React error #"+U+"; visit "+T+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function O(){}var p={d:{f:O,r:function(){throw Error(j(522))},D:O,C:O,L:O,m:O,X:O,S:O,M:O},p:0,findDOMNode:null},M=Symbol.for("react.portal");function x(U,T,C){var N=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:M,key:N==null?null:""+N,children:U,containerInfo:T,implementation:C}}var X=v.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function P(U,T){if(U==="font")return"";if(typeof T=="string")return T==="use-credentials"?T:""}return Zl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=p,Zl.createPortal=function(U,T){var C=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!T||T.nodeType!==1&&T.nodeType!==9&&T.nodeType!==11)throw Error(j(299));return x(U,T,null,C)},Zl.flushSync=function(U){var T=X.T,C=p.p;try{if(X.T=null,p.p=2,U)return U()}finally{X.T=T,p.p=C,p.d.f()}},Zl.preconnect=function(U,T){typeof U=="string"&&(T?(T=T.crossOrigin,T=typeof T=="string"?T==="use-credentials"?T:"":void 0):T=null,p.d.C(U,T))},Zl.prefetchDNS=function(U){typeof U=="string"&&p.d.D(U)},Zl.preinit=function(U,T){if(typeof U=="string"&&T&&typeof T.as=="string"){var C=T.as,N=P(C,T.crossOrigin),$=typeof T.integrity=="string"?T.integrity:void 0,yl=typeof T.fetchPriority=="string"?T.fetchPriority:void 0;C==="style"?p.d.S(U,typeof T.precedence=="string"?T.precedence:void 0,{crossOrigin:N,integrity:$,fetchPriority:yl}):C==="script"&&p.d.X(U,{crossOrigin:N,integrity:$,fetchPriority:yl,nonce:typeof T.nonce=="string"?T.nonce:void 0})}},Zl.preinitModule=function(U,T){if(typeof U=="string")if(typeof T=="object"&&T!==null){if(T.as==null||T.as==="script"){var C=P(T.as,T.crossOrigin);p.d.M(U,{crossOrigin:C,integrity:typeof T.integrity=="string"?T.integrity:void 0,nonce:typeof T.nonce=="string"?T.nonce:void 0})}}else T==null&&p.d.M(U)},Zl.preload=function(U,T){if(typeof U=="string"&&typeof T=="object"&&T!==null&&typeof T.as=="string"){var C=T.as,N=P(C,T.crossOrigin);p.d.L(U,C,{crossOrigin:N,integrity:typeof T.integrity=="string"?T.integrity:void 0,nonce:typeof T.nonce=="string"?T.nonce:void 0,type:typeof T.type=="string"?T.type:void 0,fetchPriority:typeof T.fetchPriority=="string"?T.fetchPriority:void 0,referrerPolicy:typeof T.referrerPolicy=="string"?T.referrerPolicy:void 0,imageSrcSet:typeof T.imageSrcSet=="string"?T.imageSrcSet:void 0,imageSizes:typeof T.imageSizes=="string"?T.imageSizes:void 0,media:typeof T.media=="string"?T.media:void 0})}},Zl.preloadModule=function(U,T){if(typeof U=="string")if(T){var C=P(T.as,T.crossOrigin);p.d.m(U,{as:typeof T.as=="string"&&T.as!=="script"?T.as:void 0,crossOrigin:C,integrity:typeof T.integrity=="string"?T.integrity:void 0})}else p.d.m(U)},Zl.requestFormReset=function(U){p.d.r(U)},Zl.unstable_batchedUpdates=function(U,T){return U(T)},Zl.useFormState=function(U,T,C){return X.H.useFormState(U,T,C)},Zl.useFormStatus=function(){return X.H.useHostTransitionStatus()},Zl.version="19.2.3",Zl}var Mf;function mm(){if(Mf)return po.exports;Mf=1;function v(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(v)}catch(j){console.error(j)}}return v(),po.exports=dm(),po.exports}var jf;function hm(){if(jf)return Te;jf=1;var v=pm(),j=ho(),O=mm();function p(l){var t="https://react.dev/errors/"+l;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+l+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function M(l){return!(!l||l.nodeType!==1&&l.nodeType!==9&&l.nodeType!==11)}function x(l){var t=l,n=l;if(l.alternate)for(;t.return;)t=t.return;else{l=t;do t=l,(t.flags&4098)!==0&&(n=t.return),l=t.return;while(l)}return t.tag===3?n:null}function X(l){if(l.tag===13){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function P(l){if(l.tag===31){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function U(l){if(x(l)!==l)throw Error(p(188))}function T(l){var t=l.alternate;if(!t){if(t=x(l),t===null)throw Error(p(188));return t!==l?null:l}for(var n=l,i=t;;){var e=n.return;if(e===null)break;var a=e.alternate;if(a===null){if(i=e.return,i!==null){n=i;continue}break}if(e.child===a.child){for(a=e.child;a;){if(a===n)return U(e),l;if(a===i)return U(e),t;a=a.sibling}throw Error(p(188))}if(n.return!==i.return)n=e,i=a;else{for(var s=!1,u=e.child;u;){if(u===n){s=!0,n=e,i=a;break}if(u===i){s=!0,i=e,n=a;break}u=u.sibling}if(!s){for(u=a.child;u;){if(u===n){s=!0,n=a,i=e;break}if(u===i){s=!0,i=a,n=e;break}u=u.sibling}if(!s)throw Error(p(189))}}if(n.alternate!==i)throw Error(p(190))}if(n.tag!==3)throw Error(p(188));return n.stateNode.current===n?l:t}function C(l){var t=l.tag;if(t===5||t===26||t===27||t===6)return l;for(l=l.child;l!==null;){if(t=C(l),t!==null)return t;l=l.sibling}return null}var N=Object.assign,$=Symbol.for("react.element"),yl=Symbol.for("react.transitional.element"),vl=Symbol.for("react.portal"),_l=Symbol.for("react.fragment"),Ul=Symbol.for("react.strict_mode"),bl=Symbol.for("react.profiler"),Ml=Symbol.for("react.consumer"),ul=Symbol.for("react.context"),Tl=Symbol.for("react.forward_ref"),Vl=Symbol.for("react.suspense"),Sl=Symbol.for("react.suspense_list"),K=Symbol.for("react.memo"),Hl=Symbol.for("react.lazy"),Jl=Symbol.for("react.activity"),Ft=Symbol.for("react.memo_cache_sentinel"),pt=Symbol.iterator;function kl(l){return l===null||typeof l!="object"?null:(l=pt&&l[pt]||l["@@iterator"],typeof l=="function"?l:null)}var wn=Symbol.for("react.client.reference");function xt(l){if(l==null)return null;if(typeof l=="function")return l.$$typeof===wn?null:l.displayName||l.name||null;if(typeof l=="string")return l;switch(l){case _l:return"Fragment";case bl:return"Profiler";case Ul:return"StrictMode";case Vl:return"Suspense";case Sl:return"SuspenseList";case Jl:return"Activity"}if(typeof l=="object")switch(l.$$typeof){case vl:return"Portal";case ul:return l.displayName||"Context";case Ml:return(l._context.displayName||"Context")+".Consumer";case Tl:var t=l.render;return l=l.displayName,l||(l=t.displayName||t.name||"",l=l!==""?"ForwardRef("+l+")":"ForwardRef"),l;case K:return t=l.displayName||null,t!==null?t:xt(l.type)||"Memo";case Hl:t=l._payload,l=l._init;try{return xt(l(t))}catch{}}return null}var At=Array.isArray,z=j.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,E=O.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G={pending:!1,data:null,method:null,action:null},ol=[],fl=-1;function g(l){return{current:l}}function w(l){0>fl||(l.current=ol[fl],ol[fl]=null,fl--)}function D(l,t){fl++,ol[fl]=l.current,l.current=t}var H=g(null),Q=g(null),J=g(null),el=g(null);function $l(l,t){switch(D(J,t),D(Q,l),D(H,null),t.nodeType){case 9:case 11:l=(l=t.documentElement)&&(l=l.namespaceURI)?Gg(l):0;break;default:if(l=t.tagName,t=t.namespaceURI)t=Gg(t),l=Lg(t,l);else switch(l){case"svg":l=1;break;case"math":l=2;break;default:l=0}}w(H),D(H,l)}function jl(){w(H),w(Q),w(J)}function Ci(l){l.memoizedState!==null&&D(el,l);var t=H.current,n=Lg(t,l.type);t!==n&&(D(Q,l),D(H,n))}function Ae(l){Q.current===l&&(w(H),w(Q)),el.current===l&&(w(el),ve._currentValue=G)}var Va,yo;function Mn(l){if(Va===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);Va=t&&t[1]||"",yo=-1<n.stack.indexOf(`
    at`)?" (<anonymous>)":-1<n.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Va+l+yo}var Za=!1;function $a(l,t){if(!l||Za)return"";Za=!0;var n=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var i={DetermineComponentFrameRoot:function(){try{if(t){var A=function(){throw Error()};if(Object.defineProperty(A.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(A,[])}catch(b){var y=b}Reflect.construct(l,[],A)}else{try{A.call()}catch(b){y=b}l.call(A.prototype)}}else{try{throw Error()}catch(b){y=b}(A=l())&&typeof A.catch=="function"&&A.catch(function(){})}}catch(b){if(b&&y&&typeof b.stack=="string")return[b.stack,y.stack]}return[null,null]}};i.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var e=Object.getOwnPropertyDescriptor(i.DetermineComponentFrameRoot,"name");e&&e.configurable&&Object.defineProperty(i.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var a=i.DetermineComponentFrameRoot(),s=a[0],u=a[1];if(s&&u){var r=s.split(`
`),h=u.split(`
...
<p><strong>Совет:</strong> Попробуй несколько нейросетей — у каждой своя интерпретация.</p>
  ...
  `},{day:19,date:"2026-01-07",tanya_gift:"Круиз: по-венски",zebra_gift:"Круиз: по-индийски (х2)",tanya_bonus:"Аскорбинка",zebra_bonus:"Аскорбинка",title:"День 18",tanya_message:`
    <Кажется, я разобралась. Один крутанский кофе должен был быть вчера, и вот текст про него.>
      <img src="${o.christmas}" />
