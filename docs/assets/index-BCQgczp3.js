...
<p><strong>Совет:</strong> Попробуй несколько нейросетей — у каждой своя интерпретация.</p>
  ...
  `,zebra_message:`
    ...
    <p>
      ...
      Но ты пишешь, что он попался тебе 14 числа (день 14)!<br>
      <strong>Вопрос:</strong> Где твоя шоколадка от дня 14? Была ли она в реальности? Мои записи в этом месте довольно сбивчивы.<br>
      И что тогда прилагается к конверту 16?..
    </p>
    ...
    <h4>Единороги в мифологии 🦄📜</h4>
    
    <p><strong>История единорогов:</strong></p>
    <ul>
      <li><strong>Древность:</strong> Упоминания в мифах Месопотамии, Индии, Китая (3000+ лет назад)</li>
      <li><strong>Европа (Средние века):</strong> Символ чистоты, невинности, магии</li>
      <li><strong>Легенда:</strong> Единорогов можно поймать только с помощью девственницы</li>
      <li><strong>Рог единорога:</strong> Обладает магическими свойствами (исцеление, очищение от ядов)</li>
      <li><strong>Редкость:</strong> Единорогов почти невозможно найти → символ недостижимого, мечты</li>
    </ul>
    
    <p><strong>Единороги в геральдике:</strong></p>
    <ul>
      <li>Символ Шотландии (на гербе Великобритании — единорог и лев!)</li>
      <li>Означает: силу, благородство, свободу (единорога невозможно приручить)</li>
    </ul>
