...
`},{day:8,date:"2025-12-27",tanya_gift:'Какао "Опоссум" (пьёт и больше не орёт)',zebra_gift:'Какао "Опоссум" (пьёт и больше не орёт)',tanya_bonus:"Маршмеллоу (маленькие)",zebra_bonus:"Маршмеллоу (маленькие)",title:"Опоссумы, какао и философия",tanya_message:`
    <p>Сегодня у нас особенный день — день <strong>опоссумов</strong>! Тех самых недооценённых, мисандерстудных, но невероятно крутых созданий.</p>
    <p>И какао. С маршмеллоу. Потому что после какао действительно меньше орёшь (по крайней мере пока он не кончится).</p>
    <img src="${M.possaMom}" />
    ...
    <ul>
      ...
      <li>Хищник нюхает: "Фу, мертвечина" — уходит</li>
    ...
    <ul>
      ...
      <li>Когда опоссумы шипят — выглядят страшно</li>
      <li>Но это блеф! Опоссумы <strong>не агрессивные</strong></li>
    </ul>
    
    <p><strong>4. Всеядные мусорщики = экологическая служба!</strong></p>
    <ul>
      <li>Едят всё: насекомых, фрукты, падаль, мусор</li>
      <li>Убирают то, что другие не едят</li>
      <li>Живут в городах → чистят от органических отходов</li>
      <li>"Trash possums" — но это комплимент! 😄</li>
    </ul>
    ...
    <ul>
      ...
      <li>Но за эти годы приносят огромную пользу!</li>
    </ul>
    ...
    <img src="${M.possOrOposs}" />
    <p><strong>Опоссумы (Opossums):</strong></p>
    <ul>
      <li>Северная и Южная Америка</li>
      <li>Виргинский опоссум (Virginia opossum) — самый известный</li>
      <li>Голый цепкий хвост</li>
      <li>Серая шерсть, розовый нос, розовые лапки</li>
      <li>Название с буквой "O"</li>
    </ul>
    
    <p><strong>Поссумы (Possums):</strong></p>
    <ul>
      <li>Австралия, Новая Гвинея</li>
      <li>Другое семейство!</li>
      <li>Пушистый хвост</li>
      <li>Разные виды (кускусы, сахарные поссумы)</li>
      <li>Название без "O"</li>
    </ul>
    
    <p><strong>Путаница:</strong> Часто говорят "possum" про опоссумов — это неправильно! Но все привыкли. 😄</p>
    ...
    <ul>
      ...
      <img src="${M.poss}" />
      <li>Футболки, стикеры, мерч</li>
      <li>Социальные медиа: #opossums, #trashanimals, #opossumpower</li>
...
<p>В США есть <strong>официальный неофициальный праздник</strong>, посвящённый опоссумам!</p>
...
<ul>
  ...
  <li>Инфлюенсеры рассказывают о пользе опоссумов</li>
</ul>

<p><strong>Мерч и fundraising:</strong></p>
<ul>
  <li>Футболки "I ♥ Opossums" (как у тебя!)</li>
  <li>Стикеры, значки, открытки</li>
...
<h4>Сегодня — наш опоссумный день!</h4>
