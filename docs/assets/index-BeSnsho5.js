(function(){const M=document.createElement("link").relList;if(M&&M.supports&&M.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))f(A);new MutationObserver(A=>{for(const x of A)if(x.type==="childList")for(const Y of x.addedNodes)Y.tagName==="LINK"&&Y.rel==="modulepreload"&&f(Y)}).observe(document,{childList:!0,subtree:!0});function O(A){const x={};return A.integrity&&(x.integrity=A.integrity),A.referrerPolicy&&(x.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?x.credentials="include":A.crossOrigin==="anonymous"?x.credentials="omit":x.credentials="same-origin",x}function f(A){if(A.ep)return;A.ep=!0;const x=O(A);fetch(A.href,x)}})();var ur={exports:{}},zn={};var bp;function um(){if(bp)return zn;bp=1;var b=Symbol.for("react.transitional.element"),M=Symbol.for("react.fragment");function O(f,A,x){var Y=null;if(x!==void 0&&(Y=""+x),A.key!==void 0&&(Y=""+A.key),"key"in A){x={};for(var P in A)P!=="key"&&(x[P]=A[P])}else x=A;return A=x.ref,{$$typeof:b,type:f,key:Y,ref:A!==void 0?A:null,props:x}}return zn.Fragment=M,zn.jsx=O,zn.jsxs=O,zn}var vp;function cm(){return vp||(vp=1,ur.exports=um()),ur.exports}var d=cm(),cr={exports:{}},L={};var Sp;function gm(){if(Sp)return L;Sp=1;var b=Symbol.for("react.transitional.element"),M=Symbol.for("react.portal"),O=Symbol.for("react.fragment"),f=Symbol.for("react.strict_mode"),A=Symbol.for("react.profiler"),x=Symbol.for("react.consumer"),Y=Symbol.for("react.context"),P=Symbol.for("react.forward_ref"),U=Symbol.for("react.suspense"),_=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),N=Symbol.for("react.activity"),V=Symbol.iterator;function yl(g){return g===null||typeof g!="object"?null:(g=V&&g[V]||g["@@iterator"],typeof g=="function"?g:null)}var bl={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},zl=Object.assign,Ul={};function vl(g,j,D){this.props=g,this.context=j,this.refs=Ul,this.updater=D||bl}vl.prototype.isReactComponent={},vl.prototype.setState=function(g,j){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,g,j,"setState")},vl.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function Al(){}Al.prototype=vl.prototype;function ol(g,j,D){this.props=g,this.context=j,this.refs=Ul,this.updater=D||bl}var _l=ol.prototype=new Al;_l.constructor=ol,zl(_l,vl.prototype),_l.isPureReactComponent=!0;var Ql=Array.isArray;function Sl(){}var k={H:null,A:null,T:null,S:null},Rl=Object.prototype.hasOwnProperty;function Kl(g,j,D){var R=D.ref;return{$$typeof:b,type:g,key:j,ref:R!==void 0?R:null,props:D}}function Ft(g,j){return Kl(g.type,j,g.props)}function ft(g){return typeof g=="object"&&g!==null&&g.$$typeof===b}function Jl(g){var j={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(D){return j[D]})}var Ti=/\/+/g;function xt(g,j){return typeof g=="object"&&g!==null&&g.key!=null?Jl(""+g.key):j.toString(36)}function Tt(g){switch(g.status){case"fulfilled":return g.value;case"rejected":throw g.reason;default:switch(typeof g.status=="string"?g.then(Sl,Sl):(g.status="pending",g.then(function(j){g.status==="pending"&&(g.status="fulfilled",g.value=j)},function(j){g.status==="pending"&&(g.status="rejected",g.reason=j)})),g.status){case"fulfilled":return g.value;case"rejected":throw g.reason}}throw g}function w(g,j,D,R,$){var K=typeof g;(K==="undefined"||K==="boolean")&&(g=null);var nl=!1;if(g===null)nl=!0;else switch(K){case"bigint":case"string":case"number":nl=!0;break;case"object":switch(g.$$typeof){case b:case M:nl=!0;break;case E:return nl=g._init,w(nl(g._payload),j,D,R,$)}}if(nl)return $=$(g),nl=R===""?"."+xt(g,0):R,Ql($)?(D="",nl!=null&&(D=nl.replace(Ti,"$&/")+"/"),w($,j,D,"",function(Ce){return Ce})):$!=null&&(ft($)&&($=Ft($,D+($.key==null||g&&g.key===$.key?"":(""+$.key).replace(Ti,"$&/")+"/")+nl)),j.push($)),1;nl=0;var Vl=R===""?".":R+":";if(Ql(g))for(var Ml=0;Ml<g.length;Ml++)R=g[Ml],K=Vl+xt(R,Ml),nl+=w(R,j,D,K,$);else if(Ml=yl(g),typeof Ml=="function")for(g=Ml.call(g),Ml=0;!(R=g.next()).done;)R=R.value,K=Vl+xt(R,Ml++),nl+=w(R,j,D,K,$);else if(K==="object"){if(typeof g.then=="function")return w(Tt(g),j,D,R,$);throw j=String(g),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return nl}function C(g,j,D){if(g==null)return g;var R=[],$=0;return w(g,R,"","",function(K){return j.call(D,K,$++)}),R}function G(g){if(g._status===-1){var j=g._result;j=j(),j.then(function(D){(g._status===0||g._status===-1)&&(g._status=1,g._result=D)},function(D){(g._status===0||g._status===-1)&&(g._status=2,g._result=D)}),g._status===-1&&(g._status=0,g._result=j)}if(g._status===1)return g._result.default;throw g._result}var rl=typeof reportError=="function"?reportError:function(g){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof g=="object"&&g!==null&&typeof g.message=="string"?String(g.message):String(g),error:g});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",g);return}console.error(g)},pl={map:C,forEach:function(g,j,D){C(g,function(){j.apply(this,arguments)},D)},count:function(g){var j=0;return C(g,function(){j++}),j},toArray:function(g){return C(g,function(j){return j})||[]},only:function(g){if(!ft(g))throw Error("React.Children.only expected to receive a single React element child.");return g}};return L.Activity=N,L.Children=pl,L.Component=vl,L.Fragment=O,L.Profiler=A,L.PureComponent=ol,L.StrictMode=f,L.Suspense=U,L.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=k,L.__COMPILER_RUNTIME={__proto__:null,c:function(g){return k.H.useMemoCache(g)}},L.cache=function(g){return function(){return g.apply(null,arguments)}},L.cacheSignal=function(){return null},L.cloneElement=function(g,j,D){if(g==null)throw Error("The argument must be a React element, but you passed "+g+".");var R=zl({},g.props),$=g.key;if(j!=null)for(K in j.key!==void 0&&($=""+j.key),j)!Rl.call(j,K)||K==="key"||K==="__self"||K==="__source"||K==="ref"&&j.ref===void 0||(R[K]=j[K]);var K=arguments.length-2;if(K===1)R.children=D;else if(1<K){for(var nl=Array(K),Vl=0;Vl<K;Vl++)nl[Vl]=arguments[Vl+2];R.children=nl}return Kl(g.type,$,R)},L.createContext=function(g){return g={$$typeof:Y,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider=g,g.Consumer={$$typeof:x,_context:g},g},L.createElement=function(g,j,D){var R,$={},K=null;if(j!=null)for(R in j.key!==void 0&&(K=""+j.key),j)Rl.call(j,R)&&R!=="key"&&R!=="__self"&&R!=="__source"&&($[R]=j[R]);var nl=arguments.length-2;if(nl===1)$.children=D;else if(1<nl){for(var Vl=Array(nl),Ml=0;Ml<nl;Ml++)Vl[Ml]=arguments[Ml+2];$.children=Vl}if(g&&g.defaultProps)for(R in nl=g.defaultProps,nl)$[R]===void 0&&($[R]=nl[R]);return Kl(g,K,$)},L.createRef=function(){return{current:null}},L.forwardRef=function(g){return{$$typeof:P,render:g}},L.isValidElement=ft,L.lazy=function(g){return{$$typeof:E,_payload:{_status:-1,_result:g},_init:G}},L.memo=function(g,j){return{$$typeof:_,type:g,compare:j===void 0?null:j}},L.startTransition=function(g){var j=k.T,D={};k.T=D;try{var R=g(),$=k.S;$!==null&&$(D,R),typeof R=="object"&&R!==null&&typeof R.then=="function"&&R.then(Sl,rl)}catch(K){rl(K)}finally{j!==null&&D.types!==null&&(j.types=D.types),k.T=j}},L.unstable_useCacheRefresh=function(){return k.H.useCacheRefresh()},L.use=function(g){return k.H.use(g)},L.useActionState=function(g,j,D){return k.H.useActionState(g,j,D)},L.useCallback=function(g,j){return k.H.useCallback(g,j)},L.useContext=function(g){return k.H.useContext(g)},L.useDebugValue=function(){},L.useDeferredValue=function(g,j){return k.H.useDeferredValue(g,j)},L.useEffect=function(g,j){return k.H.useEffect(g,j)},L.useEffectEvent=function(g){return k.H.useEffectEvent(g)},L.useId=function(){return k.H.useId()},L.useImperativeHandle=function(g,j,D){return k.H.useImperativeHandle(g,j,D)},L.useInsertionEffect=function(g,j){return k.H.useInsertionEffect(g,j)},L.useLayoutEffect=function(g,j){return k.H.useLayoutEffect(g,j)},L.useMemo=function(g,j){return k.H.useMemo(g,j)},L.useOptimistic=function(g,j){return k.H.useOptimistic(g,j)},L.useReducer=function(g,j,D){return k.H.useReducer(g,j,D)},L.useRef=function(g){return k.H.useRef(g)},L.useState=function(g){return k.H.useState(g)},L.useSyncExternalStore=function(g,j,D){return k.H.useSyncExternalStore(g,j,D)},L.useTransition=function(){return k.H.useTransition()},L.version="19.2.3",L}var wp;function hr(){return wp||(wp=1,cr.exports=gm()),cr.exports}var wl=hr(),gr={exports:{}},_n={},pr={exports:{}},fr={};var zp;function pm(){return zp||(zp=1,(function(b){function M(w,C){var G=w.length;w.push(C);l:for(;0<G;){var rl=G-1>>>1,pl=w[rl];if(0<A(pl,C))w[rl]=C,w[G]=pl,G=rl;else break l}}function O(w){return w.length===0?null:w[0]}function f(w){if(w.length===0)return null;var C=w[0],G=w.pop();if(G!==C){w[0]=G;l:for(var rl=0,pl=w.length,g=pl>>>1;rl<g;){var j=2*(rl+1)-1,D=w[j],R=j+1,$=w[R];if(0>A(D,G))R<pl&&0>A($,D)?(w[rl]=$,w[R]=G,rl=R):(w[rl]=D,w[j]=G,rl=j);else if(R<pl&&0>A($,G))w[rl]=$,w[R]=G,rl=R;else break l}}return C}function A(w,C){var G=w.sortIndex-C.sortIndex;return G!==0?G:w.id-C.id}if(b.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var x=performance;b.unstable_now=function(){return x.now()}}else{var Y=Date,P=Y.now();b.unstable_now=function(){return Y.now()-P}}var U=[],_=[],E=1,N=null,V=3,yl=!1,bl=!1,zl=!1,Ul=!1,vl=typeof setTimeout=="function"?setTimeout:null,Al=typeof clearTimeout=="function"?clearTimeout:null,ol=typeof setImmediate<"u"?setImmediate:null;function _l(w){for(var C=O(_);C!==null;){if(C.callback===null)f(_);else if(C.startTime<=w)f(_),C.sortIndex=C.expirationTime,M(U,C);else break;C=O(_)}}function Ql(w){if(zl=!1,_l(w),!bl)if(O(U)!==null)bl=!0,Sl||(Sl=!0,Jl());else{var C=O(_);C!==null&&Tt(Ql,C.startTime-w)}}var Sl=!1,k=-1,Rl=5,Kl=-1;function Ft(){return Ul?!0:!(b.unstable_now()-Kl<Rl)}function ft(){if(Ul=!1,Sl){var w=b.unstable_now();Kl=w;var C=!0;try{l:{bl=!1,zl&&(zl=!1,Al(k),k=-1),yl=!0;var G=V;try{t:{for(_l(w),N=O(U);N!==null&&!(N.expirationTime>w&&Ft());){var rl=N.callback;if(typeof rl=="function"){N.callback=null,V=N.priorityLevel;var pl=rl(N.expirationTime<=w);if(w=b.unstable_now(),typeof pl=="function"){N.callback=pl,_l(w),C=!0;break t}N===O(U)&&f(U),_l(w)}else f(U);N=O(U)}if(N!==null)C=!0;else{var g=O(_);g!==null&&Tt(Ql,g.startTime-w),C=!1}}break l}finally{N=null,V=G,yl=!1}C=void 0}}finally{C?Jl():Sl=!1}}}var Jl;if(typeof ol=="function")Jl=function(){ol(ft)};else if(typeof MessageChannel<"u"){var Ti=new MessageChannel,xt=Ti.port2;Ti.port1.onmessage=ft,Jl=function(){xt.postMessage(null)}}else Jl=function(){vl(ft,0)};function Tt(w,C){k=vl(function(){w(b.unstable_now())},C)}b.unstable_IdlePriority=5,b.unstable_ImmediatePriority=1,b.unstable_LowPriority=4,b.unstable_NormalPriority=3,b.unstable_Profiling=null,b.unstable_UserBlockingPriority=2,b.unstable_cancelCallback=function(w){w.callback=null},b.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Rl=0<w?Math.floor(1e3/w):5},b.unstable_getCurrentPriorityLevel=function(){return V},b.unstable_next=function(w){switch(V){case 1:case 2:case 3:var C=3;break;default:C=V}var G=V;V=C;try{return w()}finally{V=G}},b.unstable_requestPaint=function(){Ul=!0},b.unstable_runWithPriority=function(w,C){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var G=V;V=w;try{return C()}finally{V=G}},b.unstable_scheduleCallback=function(w,C,G){var rl=b.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?rl+G:rl):G=rl,w){case 1:var pl=-1;break;case 2:pl=250;break;case 5:pl=1073741823;break;case 4:pl=1e4;break;default:pl=5e3}return pl=G+pl,w={id:E++,callback:C,priorityLevel:w,startTime:G,expirationTime:pl,sortIndex:-1},G>rl?(w.sortIndex=G,M(_,w),O(U)===null&&w===O(_)&&(zl?(Al(k),k=-1):zl=!0,Tt(Ql,G-rl))):(w.sortIndex=pl,M(U,w),bl||yl||(bl=!0,Sl||(Sl=!0,Jl()))),w},b.unstable_shouldYield=Ft,b.unstable_wrapCallback=function(w){var C=V;return function(){var G=V;V=C;try{return w.apply(this,arguments)}finally{V=G}}}})(fr)),fr}var _p;function fm(){return _p||(_p=1,pr.exports=pm()),pr.exports}var dr={exports:{}},Zl={};var Tp;function dm(){if(Tp)return Zl;Tp=1;var b=hr();function M(U){var _="https://react.dev/errors/"+U;if(1<arguments.length){_+="?args[]="+encodeURIComponent(arguments[1]);for(var E=2;E<arguments.length;E++)_+="&args[]="+encodeURIComponent(arguments[E])}return"Minified React error #"+U+"; visit "+_+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function O(){}var f={d:{f:O,r:function(){throw Error(M(522))},D:O,C:O,L:O,m:O,X:O,S:O,M:O},p:0,findDOMNode:null},A=Symbol.for("react.portal");function x(U,_,E){var N=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:A,key:N==null?null:""+N,children:U,containerInfo:_,implementation:E}}var Y=b.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function P(U,_){if(U==="font")return"";if(typeof _=="string")return _==="use-credentials"?_:""}return Zl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=f,Zl.createPortal=function(U,_){var E=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!_||_.nodeType!==1&&_.nodeType!==9&&_.nodeType!==11)throw Error(M(299));return x(U,_,null,E)},Zl.flushSync=function(U){var _=Y.T,E=f.p;try{if(Y.T=null,f.p=2,U)return U()}finally{Y.T=_,f.p=E,f.d.f()}},Zl.preconnect=function(U,_){typeof U=="string"&&(_?(_=_.crossOrigin,_=typeof _=="string"?_==="use-credentials"?_:"":void 0):_=null,f.d.C(U,_))},Zl.prefetchDNS=function(U){typeof U=="string"&&f.d.D(U)},Zl.preinit=function(U,_){if(typeof U=="string"&&_&&typeof _.as=="string"){var E=_.as,N=P(E,_.crossOrigin),V=typeof _.integrity=="string"?_.integrity:void 0,yl=typeof _.fetchPriority=="string"?_.fetchPriority:void 0;E==="style"?f.d.S(U,typeof _.precedence=="string"?_.precedence:void 0,{crossOrigin:N,integrity:V,fetchPriority:yl}):E==="script"&&f.d.X(U,{crossOrigin:N,integrity:V,fetchPriority:yl,nonce:typeof _.nonce=="string"?_.nonce:void 0})}},Zl.preinitModule=function(U,_){if(typeof U=="string")if(typeof _=="object"&&_!==null){if(_.as==null||_.as==="script"){var E=P(_.as,_.crossOrigin);f.d.M(U,{crossOrigin:E,integrity:typeof _.integrity=="string"?_.integrity:void 0,nonce:typeof _.nonce=="string"?_.nonce:void 0})}}else _==null&&f.d.M(U)},Zl.preload=function(U,_){if(typeof U=="string"&&typeof _=="object"&&_!==null&&typeof _.as=="string"){var E=_.as,N=P(E,_.crossOrigin);f.d.L(U,E,{crossOrigin:N,integrity:typeof _.integrity=="string"?_.integrity:void 0,nonce:typeof _.nonce=="string"?_.nonce:void 0,type:typeof _.type=="string"?_.type:void 0,fetchPriority:typeof _.fetchPriority=="string"?_.fetchPriority:void 0,referrerPolicy:typeof _.referrerPolicy=="string"?_.referrerPolicy:void 0,imageSrcSet:typeof _.imageSrcSet=="string"?_.imageSrcSet:void 0,imageSizes:typeof _.imageSizes=="string"?_.imageSizes:void 0,media:typeof _.media=="string"?_.media:void 0})}},Zl.preloadModule=function(U,_){if(typeof U=="string")if(_){var E=P(_.as,_.crossOrigin);f.d.m(U,{as:typeof _.as=="string"&&_.as!=="script"?_.as:void 0,crossOrigin:E,integrity:typeof _.integrity=="string"?_.integrity:void 0})}else f.d.m(U)},Zl.requestFormReset=function(U){f.d.r(U)},Zl.unstable_batchedUpdates=function(U,_){return U(_)},Zl.useFormState=function(U,_,E){return Y.H.useFormState(U,_,E)},Zl.useFormStatus=function(){return Y.H.useHostTransitionStatus()},Zl.version="19.2.3",Zl}var jp;function mm(){if(jp)return dr.exports;jp=1;function b(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(b)}catch(M){console.error(M)}}return b(),dr.exports=dm(),dr.exports}var Ap;function hm(){if(Ap)return _n;Ap=1;var b=fm(),M=hr(),O=mm();function f(l){var t="https://react.dev/errors/"+l;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var i=2;i<arguments.length;i++)t+="&args[]="+encodeURIComponent(arguments[i])}return"Minified React error #"+l+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function A(l){return!(!l||l.nodeType!==1&&l.nodeType!==9&&l.nodeType!==11)}function x(l){var t=l,i=l;if(l.alternate)for(;t.return;)t=t.return;else{l=t;do t=l,(t.flags&4098)!==0&&(i=t.return),l=t.return;while(l)}return t.tag===3?i:null}function Y(l){if(l.tag===13){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function P(l){if(l.tag===31){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function U(l){if(x(l)!==l)throw Error(f(188))}function _(l){var t=l.alternate;if(!t){if(t=x(l),t===null)throw Error(f(188));return t!==l?null:l}for(var i=l,e=t;;){var n=i.return;if(n===null)break;var a=n.alternate;if(a===null){if(e=n.return,e!==null){i=e;continue}break}if(n.child===a.child){for(a=n.child;a;){if(a===i)return U(n),l;if(a===e)return U(n),t;a=a.sibling}throw Error(f(188))}if(i.return!==e.return)i=n,e=a;else{for(var s=!1,r=n.child;r;){if(r===i){s=!0,i=n,e=a;break}if(r===e){s=!0,e=n,i=a;break}r=r.sibling}if(!s){for(r=a.child;r;){if(r===i){s=!0,i=a,e=n;break}if(r===e){s=!0,e=a,i=n;break}r=r.sibling}if(!s)throw Error(f(189))}}if(i.alternate!==e)throw Error(f(190))}if(i.tag!==3)throw Error(f(188));return i.stateNode.current===i?l:t}function E(l){var t=l.tag;if(t===5||t===26||t===27||t===6)return l;for(l=l.child;l!==null;){if(t=E(l),t!==null)return t;l=l.sibling}return null}var N=Object.assign,V=Symbol.for("react.element"),yl=Symbol.for("react.transitional.element"),bl=Symbol.for("react.portal"),zl=Symbol.for("react.fragment"),Ul=Symbol.for("react.strict_mode"),vl=Symbol.for("react.profiler"),Al=Symbol.for("react.consumer"),ol=Symbol.for("react.context"),_l=Symbol.for("react.forward_ref"),Ql=Symbol.for("react.suspense"),Sl=Symbol.for("react.suspense_list"),k=Symbol.for("react.memo"),Rl=Symbol.for("react.lazy"),Kl=Symbol.for("react.activity"),Ft=Symbol.for("react.memo_cache_sentinel"),ft=Symbol.iterator;function Jl(l){return l===null||typeof l!="object"?null:(l=ft&&l[ft]||l["@@iterator"],typeof l=="function"?l:null)}var Ti=Symbol.for("react.client.reference");function xt(l){if(l==null)return null;if(typeof l=="function")return l.$$typeof===Ti?null:l.displayName||l.name||null;if(typeof l=="string")return l;switch(l){case zl:return"Fragment";case vl:return"Profiler";case Ul:return"StrictMode";case Ql:return"Suspense";case Sl:return"SuspenseList";case Kl:return"Activity"}if(typeof l=="object")switch(l.$$typeof){case bl:return"Portal";case ol:return l.displayName||"Context";case Al:return(l._context.displayName||"Context")+".Consumer";case _l:var t=l.render;return l=l.displayName,l||(l=t.displayName||t.name||"",l=l!==""?"ForwardRef("+l+")":"ForwardRef"),l;case k:return t=l.displayName||null,t!==null?t:xt(l.type)||"Memo";case Rl:t=l._payload,l=l._init;try{return xt(l(t))}catch{}}return null}var Tt=Array.isArray,w=M.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,C=O.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G={pending:!1,data:null,method:null,action:null},rl=[],pl=-1;function g(l){return{current:l}}function j(l){0>pl||(l.current=rl[pl],rl[pl]=null,pl--)}function D(l,t){pl++,rl[pl]=l.current,l.current=t}var R=g(null),$=g(null),K=g(null),nl=g(null);function Vl(l,t){switch(D(K,t),D($,l),D(R,null),t.nodeType){case 9:case 11:l=(l=t.documentElement)&&(l=l.namespaceURI)?Gg(l):0;break;default:if(l=t.tagName,t=t.namespaceURI)t=Gg(t),l=Lg(t,l);else switch(l){case"svg":l=1;break;case"math":l=2;break;default:l=0}}j(R),D(R,l)}function Ml(){j(R),j($),j(K)}function Ce(l){l.memoizedState!==null&&D(nl,l);var t=R.current,i=Lg(t,l.type);t!==i&&(D($,l),D(R,i))}function Tn(l){$.current===l&&(j(R),j($)),nl.current===l&&(j(nl),bn._currentValue=G)}var Qa,yr;function ji(l){if(Qa===void 0)try{throw Error()}catch(i){var t=i.stack.trim().match(/\n( *(at )?)/);Qa=t&&t[1]||"",yr=-1<i.stack.indexOf(`
    at`)?" (<anonymous>)":-1<i.stack.indexOf("@")?"@unknown:0:0":""}return`
`+Qa+l+yr}var Za=!1;function Va(l,t){if(!l||Za)return"";Za=!0;var i=Error.prepareStackTrace;Error.prepareStackTrace=void 0;try{var e={DetermineComponentFrameRoot:function(){try{if(t){var T=function(){throw Error()};if(Object.defineProperty(T.prototype,"props",{set:function(){throw Error()}}),typeof Reflect=="object"&&Reflect.construct){try{Reflect.construct(T,[])}catch(v){var y=v}Reflect.construct(l,[],T)}else{try{T.call()}catch(v){y=v}l.call(T.prototype)}}else{try{throw Error()}catch(v){y=v}(T=l())&&typeof T.catch=="function"&&T.catch(function(){})}}catch(v){if(v&&y&&typeof v.stack=="string")return[v.stack,y.stack]}return[null,null]}};e.DetermineComponentFrameRoot.displayName="DetermineComponentFrameRoot";var n=Object.getOwnPropertyDescriptor(e.DetermineComponentFrameRoot,"name");n&&n.configurable&&Object.defineProperty(e.DetermineComponentFrameRoot,"name",{value:"DetermineComponentFrameRoot"});var a=e.DetermineComponentFrameRoot(),s=a[0],r=a[1];if(s&&r){var u=s.split(`
`),h=r.split(`
...
`},{day:25,date:"2026-01-13",tanya_gift:"Желтая субмарина",zebra_gift:"Неведомый чай",tanya_bonus:"кофейная пастила",zebra_bonus:"Кофейная пастила",title:"День 24",tanya_message:` 
  ...
  <ol>
    ...
    <ol>
      ...
      `},{day:31,date:"2026-01-19",tanya_gift:"Иисус любит тебя",zebra_gift:"Эфиопия Гуджи (х2)",tanya_bonus:"Бразилия Фенси",zebra_bonus:"Бразилия Фенси (х2)",title:"День 25",tanya_message:"<p>Подарок: Иисус любит тебя</p><p>Бонус: Бразилия Фенси</p>",zebra_message:"<p>Подарок: Эфиопия Гуджи (х2)</p><p>Бонус: Бразилия Фенси (х2)</p>"},{day:32,date:"2026-01-20",tanya_gift:"Иисус любит тебя",zebra_gift:"Эфиопия Гуджи (х2)",tanya_bonus:"Бразилия Фенси",zebra_bonus:"Бразилия Фенси (х2)",title:"День 25",tanya_message:"<p>Подарок: Иисус любит тебя</p><p>Бонус: Бразилия Фенси</p>",zebra_message:"<p>Подарок: Эфиопия Гуджи (х2)</p><p>Бонус: Бразилия Фенси (х2)</p>"}];function lb({currentDate:b,userName:M}){const[O,f]=wl.useState(()=>Yp()),[A,x]=wl.useState(null),Y=E=>{const N=La(E);if($a(N,b)&&(x(E),!O.has(E))){const V=Xm(E);f(V)}},P=()=>{x(null)},_=[...Array.from({length:32},(E,N)=>N+1)].sort((E,N)=>{const V=La(E),yl=La(N),bl=mr(V,b),zl=mr(yl,b),Ul=O.has(E),vl=O.has(N),Al=$a(V,b),ol=$a(yl,b),_l=Al&&!Ul,Ql=ol&&!vl,Sl=bl&&Ul,k=zl&&vl,Rl=!Al,Kl=!ol,Ft=Ul&&!bl&&Al,ft=vl&&!zl&&ol;return _l&&!Ql?-1:!_l&&Ql?1:_l&&Ql?E-N:Sl&&!k?-1:!Sl&&k?1:Rl&&!Kl?-1:!Rl&&Kl?1:Rl&&Kl||Ft&&ft?E-N:0});return d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"calendar-grid",children:_.map(E=>{const N=La(E),V=$a(N,b),yl=O.has(E),bl=mr(N,b);return d.jsx(Wm,{windowNumber:E,isActive:V,isOpened:yl,isExactMatch:bl,onClick:()=>Y(E)},E)})}),A!==null&&(()=>{const E=Py[A-1],N=M==="Tanya"?E.tanya_message:M==="Zebra"?E.zebra_message:"<p>Тут ничего нет.</p> <p>Никаких секретных посланий</p>";return d.jsx(Fm,{windowNumber:A,message:N,onClose:P})})()]})}function tb(){const[b,M]=wl.useState(!1),O=wl.useRef(null),[f,A]=wl.useState(!1);wl.useEffect(()=>{const Y=localStorage.getItem("musicEnabled");console.debug("[AudioControls] mount - musicPref=",Y),Y==="true"&&(console.debug("[AudioControls] stored preference requests autoplay but user gesture required"),A(!0))},[]),wl.useEffect(()=>{if(!f)return;const Y=()=>{console.debug("[AudioControls] user gesture detected, starting audio"),M(!0),A(!1),window.removeEventListener("pointerdown",Y),window.removeEventListener("keydown",Y)};return window.addEventListener("pointerdown",Y,{once:!0}),window.addEventListener("keydown",Y,{once:!0}),()=>{window.removeEventListener("pointerdown",Y),window.removeEventListener("keydown",Y)}},[f]),wl.useEffect(()=>{if(console.debug("[AudioControls] effect isMusicPlaying=",b,"ref=",O.current),!O.current)return;const Y=O.current;if(b)console.debug("[AudioControls] calling play()"),Y.play().then(()=>console.debug("[AudioControls] play() fulfilled")).catch(P=>{console.error("[AudioControls] Music play failed:",P),P&&P.name==="NotAllowedError"&&(console.debug("[AudioControls] play blocked; awaiting user gesture to resume"),A(!0))});else{console.debug("[AudioControls] calling pause()");try{Y.pause()}catch(P){console.error("[AudioControls] pause() failed:",P)}}},[b]);const x=()=>{const Y=!b;console.debug("[AudioControls] toggleMusic ->",Y),M(Y),localStorage.setItem("musicEnabled",String(Y))};return d.jsxs("div",{className:"audio-controls",children:[d.jsxs("button",{className:`audio-button ${b?"audio-active":""}`,onClick:x,title:"Toggle Christmas Music",children:[b?d.jsx(Bm,{size:20}):d.jsx(Hm,{size:20}),d.jsx(Om,{size:16,className:"audio-icon-secondary"})]}),d.jsx("audio",{ref:O,loop:!0,preload:"auto",src:"audio/Frost_Waltz.mp3",onCanPlay:()=>console.debug("[AudioControls] audio canplay"),onPlay:()=>console.debug("[AudioControls] audio event: play"),onPause:()=>console.debug("[AudioControls] audio event: pause"),onError:Y=>console.error("[AudioControls] audio event: error",Y)})]})}function ib(){return d.jsx("div",{className:"snowfall",children:Array.from({length:100}).map((b,M)=>d.jsx("div",{className:"snowflake",style:{left:`${Math.random()*100}%`,animationDuration:`${Math.random()*8+10}s`,animationDelay:`${Math.random()*8}s`,width:`${Math.random()*6+4}px`,height:`${Math.random()*6+4}px`}},M))})}const eb=()=>new Date;function nb(){const[b,M]=wl.useState(()=>{const x=localStorage.getItem("adventCalendarUser");return x==="Tanya"||x==="Zebra"?x:(localStorage.clear(),null)}),[O,f]=wl.useState(eb),A=x=>{localStorage.clear(),M(x),localStorage.setItem("adventCalendarUser",x)};return wl.useEffect(()=>{(async()=>{try{const P=await(await fetch("https://worldtimeapi.org/api/ip")).json(),U=new Date(P.datetime);f(U)}catch(Y){console.error("Failed to fetch current date:",Y),f(new Date)}})()},[]),d.jsxs("div",{className:"app-container",children:[d.jsx($m,{}),d.jsx(ib,{}),d.jsx(tb,{}),d.jsxs("div",{className:"content-wrapper",children:[d.jsx(Lm,{userName:b,onUserSelect:A}),d.jsx(lb,{currentDate:O,userName:b})]})]})}bm.createRoot(document.getElementById("root")).render(d.jsx(wl.StrictMode,{children:d.jsx(nb,{})}));
