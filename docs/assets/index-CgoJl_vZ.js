(function(){const j=document.createElement("link").relList;if(j&&j.supports&&j.supports("modulepreload"))return;for(const M of document.querySelectorAll('link[rel="modulepreload"]'))p(M);new MutationObserver(M=>{for(const x of M)if(x.type==="childList")for(const X of x.addedNodes)X.tagName==="LINK"&&X.rel==="modulepreload"&&p(X)}).observe(document,{childList:!0,subtree:!0});function O(M){const x={};return M.integrity&&(x.integrity=M.integrity),M.referrerPolicy&&(x.referrerPolicy=M.referrerPolicy),M.crossOrigin==="use-credentials"?x.credentials="include":M.crossOrigin==="anonymous"?x.credentials="omit":x.credentials="same-origin",x}function p(M){if(M.ep)return;M.ep=!0;const x=O(M);fetch(M.href,x)}})();var ru={exports:{}},_e={};var bf;function rm(){if(bf)return _e;bf=1;var v=Symbol.for("react.transitional.element"),j=Symbol.for("react.fragment");function O(p,M,x){var X=null;if(x!==void 0&&(X=""+x),M.key!==void 0&&(X=""+M.key),"key"in M){x={};for(var P in M)P!=="key"&&(x[P]=M[P])}else x=M;return M=x.ref,{$$typeof:v,type:p,key:X,ref:M!==void 0?M:null,props:x}}return _e.Fragment=j,_e.jsx=O,_e.jsxs=O,_e}var Sf;function cm(){return Sf||(Sf=1,ru.exports=rm()),ru.exports}var d=cm(),cu={exports:{}},L={};var zf;function gm(){if(zf)return L;zf=1;var v=Symbol.for("react.transitional.element"),j=Symbol.for("react.portal"),O=Symbol.for("react.fragment"),p=Symbol.for("react.strict_mode"),M=Symbol.for("react.profiler"),x=Symbol.for("react.consumer"),X=Symbol.for("react.context"),P=Symbol.for("react.forward_ref"),U=Symbol.for("react.suspense"),T=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),N=Symbol.for("react.activity"),$=Symbol.iterator;function yl(g){return g===null||typeof g!="object"?null:(g=$&&g[$]||g["@@iterator"],typeof g=="function"?g:null)}var vl={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},_l=Object.assign,Ul={};function bl(g,A,D){this.props=g,this.context=A,this.refs=Ul,this.updater=D||vl}bl.prototype.isReactComponent={},bl.prototype.setState=function(g,A){if(typeof g!="object"&&typeof g!="function"&&g!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,g,A,"setState")},bl.prototype.forceUpdate=function(g){this.updater.enqueueForceUpdate(this,g,"forceUpdate")};function Ml(){}Ml.prototype=bl.prototype;function ol(g,A,D){this.props=g,this.context=A,this.refs=Ul,this.updater=D||vl}var Tl=ol.prototype=new Ml;Tl.constructor=ol,_l(Tl,bl.prototype),Tl.isPureReactComponent=!0;var Vl=Array.isArray;function Sl(){}var K={H:null,A:null,T:null,S:null},Hl=Object.prototype.hasOwnProperty;function Jl(g,A,D){var H=D.ref;return{$$typeof:v,type:g,key:A,ref:H!==void 0?H:null,props:D}}function Ft(g,A){return Jl(g.type,A,g.props)}function pt(g){return typeof g=="object"&&g!==null&&g.$$typeof===v}function kl(g){var A={"=":"=0",":":"=2"};return"$"+g.replace(/[=:]/g,function(D){return A[D]})}var An=/\/+/g;function xt(g,A){return typeof g=="object"&&g!==null&&g.key!=null?kl(""+g.key):A.toString(36)}function wt(g){switch(g.status){case"fulfilled":return g.value;case"rejected":throw g.reason;default:switch(typeof g.status=="string"?g.then(Sl,Sl):(g.status="pending",g.then(function(A){g.status==="pending"&&(g.status="fulfilled",g.value=A)},function(A){g.status==="pending"&&(g.status="rejected",g.reason=A)})),g.status){case"fulfilled":return g.value;case"rejected":throw g.reason}}throw g}function z(g,A,D,H,Q){var J=typeof g;(J==="undefined"||J==="boolean")&&(g=null);var el=!1;if(g===null)el=!0;else switch(J){case"bigint":case"string":case"number":el=!0;break;case"object":switch(g.$$typeof){case v:case j:el=!0;break;case E:return el=g._init,z(el(g._payload),A,D,H,Q)}}if(el)return Q=Q(g),el=H===""?"."+xt(g,0):H,Vl(Q)?(D="",el!=null&&(D=el.replace(An,"$&/")+"/"),z(Q,A,D,"",function(Ei){return Ei})):Q!=null&&(pt(Q)&&(Q=Ft(Q,D+(Q.key==null||g&&g.key===Q.key?"":(""+Q.key).replace(An,"$&/")+"/")+el)),A.push(Q)),1;el=0;var $l=H===""?".":H+":";if(Vl(g))for(var jl=0;jl<g.length;jl++)H=g[jl],J=$l+xt(H,jl),el+=z(H,A,D,J,Q);else if(jl=yl(g),typeof jl=="function")for(g=jl.call(g),jl=0;!(H=g.next()).done;)H=H.value,J=$l+xt(H,jl++),el+=z(H,A,D,J,Q);else if(J==="object"){if(typeof g.then=="function")return z(wt(g),A,D,H,Q);throw A=String(g),Error("Objects are not valid as a React child (found: "+(A==="[object Object]"?"object with keys {"+Object.keys(g).join(", ")+"}":A)+"). If you meant to render a collection of children, use an array instead.")}return el}function C(g,A,D){if(g==null)return g;var H=[],Q=0;return z(g,H,"","",function(J){return A.call(D,J,Q++)}),H}function G(g){if(g._status===-1){var A=g._result;A=A(),A.then(function(D){(g._status===0||g._status===-1)&&(g._status=1,g._result=D)},function(D){(g._status===0||g._status===-1)&&(g._status=2,g._result=D)}),g._status===-1&&(g._status=0,g._result=A)}if(g._status===1)return g._result.default;throw g._result}var ul=typeof reportError=="function"?reportError:function(g){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var A=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof g=="object"&&g!==null&&typeof g.message=="string"?String(g.message):String(g),error:g});if(!window.dispatchEvent(A))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",g);return}console.error(g)},fl={map:C,forEach:function(g,A,D){C(g,function(){A.apply(this,arguments)},D)},count:function(g){var A=0;return C(g,function(){A++}),A},toArray:function(g){return C(g,function(A){return A})||[]},only:function(g){if(!pt(g))throw Error("React.Children.only expected to receive a single React element child.");return g}};return L.Activity=N,L.Children=fl,L.Component=bl,L.Fragment=O,L.Profiler=M,L.PureComponent=ol,L.StrictMode=p,L.Suspense=U,L.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=K,L.__COMPILER_RUNTIME={__proto__:null,c:function(g){return K.H.useMemoCache(g)}},L.cache=function(g){return function(){return g.apply(null,arguments)}},L.cacheSignal=function(){return null},L.cloneElement=function(g,A,D){if(g==null)throw Error("The argument must be a React element, but you passed "+g+".");var H=_l({},g.props),Q=g.key;if(A!=null)for(J in A.key!==void 0&&(Q=""+A.key),A)!Hl.call(A,J)||J==="key"||J==="__self"||J==="__source"||J==="ref"&&A.ref===void 0||(H[J]=A[J]);var J=arguments.length-2;if(J===1)H.children=D;else if(1<J){for(var el=Array(J),$l=0;$l<J;$l++)el[$l]=arguments[$l+2];H.children=el}return Jl(g.type,Q,H)},L.createContext=function(g){return g={$$typeof:X,_currentValue:g,_currentValue2:g,_threadCount:0,Provider:null,Consumer:null},g.Provider=g,g.Consumer={$$typeof:x,_context:g},g},L.createElement=function(g,A,D){var H,Q={},J=null;if(A!=null)for(H in A.key!==void 0&&(J=""+A.key),A)Hl.call(A,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(Q[H]=A[H]);var el=arguments.length-2;if(el===1)Q.children=D;else if(1<el){for(var $l=Array(el),jl=0;jl<el;jl++)$l[jl]=arguments[jl+2];Q.children=$l}if(g&&g.defaultProps)for(H in el=g.defaultProps,el)Q[H]===void 0&&(Q[H]=el[H]);return Jl(g,J,Q)},L.createRef=function(){return{current:null}},L.forwardRef=function(g){return{$$typeof:P,render:g}},L.isValidElement=pt,L.lazy=function(g){return{$$typeof:E,_payload:{_status:-1,_result:g},_init:G}},L.memo=function(g,A){return{$$typeof:T,type:g,compare:A===void 0?null:A}},L.startTransition=function(g){var A=K.T,D={};K.T=D;try{var H=g(),Q=K.S;Q!==null&&Q(D,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(Sl,ul)}catch(J){ul(J)}finally{A!==null&&D.types!==null&&(A.types=D.types),K.T=A}},L.unstable_useCacheRefresh=function(){return K.H.useCacheRefresh()},L.use=function(g){return K.H.use(g)},L.useActionState=function(g,A,D){return K.H.useActionState(g,A,D)},L.useCallback=function(g,A){return K.H.useCallback(g,A)},L.useContext=function(g){return K.H.useContext(g)},L.useDebugValue=function(){},L.useDeferredValue=function(g,A){return K.H.useDeferredValue(g,A)},L.useEffect=function(g,A){return K.H.useEffect(g,A)},L.useEffectEvent=function(g){return K.H.useEffectEvent(g)},L.useId=function(){return K.H.useId()},L.useImperativeHandle=function(g,A,D){return K.H.useImperativeHandle(g,A,D)},L.useInsertionEffect=function(g,A){return K.H.useInsertionEffect(g,A)},L.useLayoutEffect=function(g,A){return K.H.useLayoutEffect(g,A)},L.useMemo=function(g,A){return K.H.useMemo(g,A)},L.useOptimistic=function(g,A){return K.H.useOptimistic(g,A)},L.useReducer=function(g,A,D){return K.H.useReducer(g,A,D)},L.useRef=function(g){return K.H.useRef(g)},L.useState=function(g){return K.H.useState(g)},L.useSyncExternalStore=function(g,A,D){return K.H.useSyncExternalStore(g,A,D)},L.useTransition=function(){return K.H.useTransition()},L.version="19.2.3",L}var _f;function hu(){return _f||(_f=1,cu.exports=gm()),cu.exports}var zl=hu(),gu={exports:{}},Te={},fu={exports:{}},pu={};var Tf;function fm(){return Tf||(Tf=1,(function(v){function j(z,C){var G=z.length;z.push(C);l:for(;0<G;){var ul=G-1>>>1,fl=z[ul];if(0<M(fl,C))z[ul]=C,z[G]=fl,G=ul;else break l}}function O(z){return z.length===0?null:z[0]}function p(z){if(z.length===0)return null;var C=z[0],G=z.pop();if(G!==C){z[0]=G;l:for(var ul=0,fl=z.length,g=fl>>>1;ul<g;){var A=2*(ul+1)-1,D=z[A],H=A+1,Q=z[H];if(0>M(D,G))H<fl&&0>M(Q,D)?(z[ul]=Q,z[H]=G,ul=H):(z[ul]=D,z[A]=G,ul=A);else if(H<fl&&0>M(Q,G))z[ul]=Q,z[H]=G,ul=H;else break l}}return C}function M(z,C){var G=z.sortIndex-C.sortIndex;return G!==0?G:z.id-C.id}if(v.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var x=performance;v.unstable_now=function(){return x.now()}}else{var X=Date,P=X.now();v.unstable_now=function(){return X.now()-P}}var U=[],T=[],E=1,N=null,$=3,yl=!1,vl=!1,_l=!1,Ul=!1,bl=typeof setTimeout=="function"?setTimeout:null,Ml=typeof clearTimeout=="function"?clearTimeout:null,ol=typeof setImmediate<"u"?setImmediate:null;function Tl(z){for(var C=O(T);C!==null;){if(C.callback===null)p(T);else if(C.startTime<=z)p(T),C.sortIndex=C.expirationTime,j(U,C);else break;C=O(T)}}function Vl(z){if(_l=!1,Tl(z),!vl)if(O(U)!==null)vl=!0,Sl||(Sl=!0,kl());else{var C=O(T);C!==null&&wt(Vl,C.startTime-z)}}var Sl=!1,K=-1,Hl=5,Jl=-1;function Ft(){return Ul?!0:!(v.unstable_now()-Jl<Hl)}function pt(){if(Ul=!1,Sl){var z=v.unstable_now();Jl=z;var C=!0;try{l:{vl=!1,_l&&(_l=!1,Ml(K),K=-1),yl=!0;var G=$;try{t:{for(Tl(z),N=O(U);N!==null&&!(N.expirationTime>z&&Ft());){var ul=N.callback;if(typeof ul=="function"){N.callback=null,$=N.priorityLevel;var fl=ul(N.expirationTime<=z);if(z=v.unstable_now(),typeof fl=="function"){N.callback=fl,Tl(z),C=!0;break t}N===O(U)&&p(U),Tl(z)}else p(U);N=O(U)}if(N!==null)C=!0;else{var g=O(T);g!==null&&wt(Vl,g.startTime-z),C=!1}}break l}finally{N=null,$=G,yl=!1}C=void 0}}finally{C?kl():Sl=!1}}}var kl;if(typeof ol=="function")kl=function(){ol(pt)};else if(typeof MessageChannel<"u"){var An=new MessageChannel,xt=An.port2;An.port1.onmessage=pt,kl=function(){xt.postMessage(null)}}else kl=function(){bl(pt,0)};function wt(z,C){K=bl(function(){z(v.unstable_now())},C)}v.unstable_IdlePriority=5,v.unstable_ImmediatePriority=1,v.unstable_LowPriority=4,v.unstable_NormalPriority=3,v.unstable_Profiling=null,v.unstable_UserBlockingPriority=2,v.unstable_cancelCallback=function(z){z.callback=null},v.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Hl=0<z?Math.floor(1e3/z):5},v.unstable_getCurrentPriorityLevel=function(){return $},v.unstable_next=function(z){switch($){case 1:case 2:case 3:var C=3;break;default:C=$}var G=$;$=C;try{return z()}finally{$=G}},v.unstable_requestPaint=function(){Ul=!0},v.unstable_runWithPriority=function(z,C){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var G=$;$=z;try{return C()}finally{$=G}},v.unstable_scheduleCallback=function(z,C,G){var ul=v.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?ul+G:ul):G=ul,z){case 1:var fl=-1;break;case 2:fl=250;break;case 5:fl=1073741823;break;case 4:fl=1e4;break;default:fl=5e3}return fl=G+fl,z={id:E++,callback:C,priorityLevel:z,startTime:G,expirationTime:fl,sortIndex:-1},G>ul?(z.sortIndex=G,j(T,z),O(U)===null&&z===O(T)&&(_l?(Ml(K),K=-1):_l=!0,wt(Vl,G-ul))):(z.sortIndex=fl,j(U,z),vl||yl||(vl=!0,Sl||(Sl=!0,kl()))),z},v.unstable_shouldYield=Ft,v.unstable_wrapCallback=function(z){var C=$;return function(){var G=$;$=C;try{return z.apply(this,arguments)}finally{$=G}}}})(pu)),pu}var wf;function pm(){return wf||(wf=1,fu.exports=fm()),fu.exports}var du={exports:{}},Zl={};var Af;function dm(){if(Af)return Zl;Af=1;var v=hu();function j(U){var T="https://react.dev/errors/"+U;if(1<arguments.length){T+="?args[]="+encodeURIComponent(arguments[1]);for(var E=2;E<arguments.length;E++)T+="&args[]="+encodeURIComponent(arguments[E])}return"Minified React error #"+U+"; visit "+T+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function O(){}var p={d:{f:O,r:function(){throw Error(j(522))},D:O,C:O,L:O,m:O,X:O,S:O,M:O},p:0,findDOMNode:null},M=Symbol.for("react.portal");function x(U,T,E){var N=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:M,key:N==null?null:""+N,children:U,containerInfo:T,implementation:E}}var X=v.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function P(U,T){if(U==="font")return"";if(typeof T=="string")return T==="use-credentials"?T:""}return Zl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=p,Zl.createPortal=function(U,T){var E=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!T||T.nodeType!==1&&T.nodeType!==9&&T.nodeType!==11)throw Error(j(299));return x(U,T,null,E)},Zl.flushSync=function(U){var T=X.T,E=p.p;try{if(X.T=null,p.p=2,U)return U()}finally{X.T=T,p.p=E,p.d.f()}},Zl.preconnect=function(U,T){typeof U=="string"&&(T?(T=T.crossOrigin,T=typeof T=="string"?T==="use-credentials"?T:"":void 0):T=null,p.d.C(U,T))},Zl.prefetchDNS=function(U){typeof U=="string"&&p.d.D(U)},Zl.preinit=function(U,T){if(typeof U=="string"&&T&&typeof T.as=="string"){var E=T.as,N=P(E,T.crossOrigin),$=typeof T.integrity=="string"?T.integrity:void 0,yl=typeof T.fetchPriority=="string"?T.fetchPriority:void 0;E==="style"?p.d.S(U,typeof T.precedence=="string"?T.precedence:void 0,{crossOrigin:N,integrity:$,fetchPriority:yl}):E==="script"&&p.d.X(U,{crossOrigin:N,integrity:$,fetchPriority:yl,nonce:typeof T.nonce=="string"?T.nonce:void 0})}},Zl.preinitModule=function(U,T){if(typeof U=="string")if(typeof T=="object"&&T!==null){if(T.as==null||T.as==="script"){var E=P(T.as,T.crossOrigin);p.d.M(U,{crossOrigin:E,integrity:typeof T.integrity=="string"?T.integrity:void 0,nonce:typeof T.nonce=="string"?T.nonce:void 0})}}else T==null&&p.d.M(U)},Zl.preload=function(U,T){if(typeof U=="string"&&typeof T=="object"&&T!==null&&typeof T.as=="string"){var E=T.as,N=P(E,T.crossOrigin);p.d.L(U,E,{crossOrigin:N,integrity:typeof T.integrity=="string"?T.integrity:void 0,nonce:typeof T.nonce=="string"?T.nonce:void 0,type:typeof T.type=="string"?T.type:void 0,fetchPriority:typeof T.fetchPriority=="string"?T.fetchPriority:void 0,referrerPolicy:typeof T.referrerPolicy=="string"?T.referrerPolicy:void 0,imageSrcSet:typeof T.imageSrcSet=="string"?T.imageSrcSet:void 0,imageSizes:typeof T.imageSizes=="string"?T.imageSizes:void 0,media:typeof T.media=="string"?T.media:void 0})}},Zl.preloadModule=function(U,T){if(typeof U=="string")if(T){var E=P(T.as,T.crossOrigin);p.d.m(U,{as:typeof T.as=="string"&&T.as!=="script"?T.as:void 0,crossOrigin:E,integrity:typeof T.integrity=="string"?T.integrity:void 0})}else p.d.m(U)},Zl.requestFormReset=function(U){p.d.r(U)},Zl.unstable_batchedUpdates=function(U,T){return U(T)},Zl.useFormState=function(U,T,E){return X.H.useFormState(U,T,E)},Zl.useFormStatus=function(){return X.H.useHostTransitionStatus()},Zl.version="19.2.3",Zl}var Mf;function mm(){if(Mf)return du.exports;Mf=1;function v(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(v)}catch(j){console.error(j)}}return v(),du.exports=dm(),du.exports}var jf;function hm(){if(jf)return Te;jf=1;var v=pm(),j=hu(),O=mm();function p(l){var t="https://react.dev/errors/"+l;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var n=2;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n])}return"Minified React error #"+l+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function M(l){return!(!l||l.nodeType!==1&&l.nodeType!==9&&l.nodeType!==11)}function x(l){var t=l,n=l;if(l.alternate)for(;t.return;)t=t.return;else{l=t;do t=l,(t.flags&4098)!==0&&(n=t.return),l=t.return;while(l)}return t.tag===3?n:null}function X(l){if(l.tag===13){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function P(l){if(l.tag===31){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function U(l){if(x(l)!==l)throw Error(p(188))}function T(l){var t=l.alternate;if(!t){if(t=x(l),t===null)throw Error(p(188));return t!==l?null:l}for(var n=l,i=t;;){var e=n.return;if(e===null)break;var a=e.alternate;if(a===null){if(i=e.return,i!==null){n=i;continue}break}if(e.child===a.child){for(a=e.child;a;){if(a===n)return U(e),l;if(a===i)return U(e),t;a=a.sibling}throw Error(p(188))}if(n.return!==i.return)n=e,i=a;else{for(var s=!1,o=e.child;o;){if(o===n){s=!0,n=e,i=a;break}if(o===i){s=!0,i=e,n=a;break}o=o.sibling}if(!s){for(o=a.child;o;){if(o===n){s=!0,n=a,i=e;break}if(o===i){s=!0,i=a,n=e;break}o=o.sibling}if(!s)throw Error(p(189))}}if(n.alternate!==i)throw Error(p(190))}if(n.tag!==3)throw Error(p(188));return n.stateNode.current===n?l:t}function E(l){var t=l.tag;if(t===5||t===26||t===27||t===6)return l;for(l=l.child;l!==null;){if(t=E(l),t!==null)return t;l=l.sibling}return null}var N=Object.assign,$=Symbol.for("react.element"),yl=Symbol.for("react.transitional.element"),vl=Symbol.for("react.portal"),_l=Symbol.for("react.fragment"),Ul=Symbol.for("react.strict_mode"),bl=Symbol.for("react.profiler"),Ml=Symbol.for("react.consumer"),ol=Symbol.for("react.context"),Tl=Symbol.for("react.forward_ref"),Vl=Symbol.for("react.suspense"),Sl=Symbol.for("react.suspense_list"),K=Symbol.for("react.memo"),Hl=Symbol.for("react.lazy"),Jl=Symbol.for("react.activity"),Ft=Symbol.for("react.memo_cache_sentinel"),pt=Symbol.iterator;function kl(l){return l===null||typeof l!="object"?null:(l=pt&&l[pt]||l["@@iterator"],typeof l=="function"?l:null)}var An=Symbol.for("react.client.reference");function xt(l){if(l==null)return null;if(typeof l=="function")return l.$$typeof===An?null:l.displayName||l.name||null;if(typeof l=="string")return l;switch(l){case _l:return"Fragment";case bl:return"Profiler";case Ul:return"StrictMode";case Vl:return"Suspense";case Sl:return"SuspenseList";case Jl:return"Activity"}if(typeof l=="object")switch(l.$$typeof){case vl:return"Portal";case ol:return l.displayName||"Context";case Ml:return(l._context.displayName||"Context")+".Consumer";case Tl:var t=l.render;return l=l.displayName,l||(l=t.displayName||t.name||"",l=l!==""?"ForwardRef("+l+")":"ForwardRef"),l;case K:return t=l.displayName||null,t!==null?t:xt(l.type)||"Memo";case Hl:t=l._payload,l=l._init;try{return xt(l(t))}catch{}}return null}var wt=Array.isArray,z=j.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,C=O.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G={pending:!1,data:null,method:null,action:null},ul=[],fl=-1;function g(l){return{current:l}}function A(l){0>fl||(l.current=ul[fl],ul[fl]=null,fl--)}function D(l,t){fl++,ul[fl]=l.current,l.current=t}var H=g(null),Q=g(null),J=g(null),el=g(null);function $l(l,t){switch(D(J,t),D(Q,l),D(H,null),t.nodeType){case 9:case 11:l=(l=t.documentElement)&&(l=l.namespaceURI)?Gg(l):0;break;default:if(l=t.tagName,t=t.namespaceURI)t=Gg(t),l=Lg(t,l);else switch(l){case"svg":l=1;break;case"math":l=2;break;default:l=0}}A(H),D(H,l)}function jl(){A(H),A(Q),A(J)}function Ei(l){l.memoizedState!==null&&D(el,l);var t=H.current,n=Lg(t,l.type);t!==n&&(D(Q,l),D(H,n))}function we(l){Q.current===l&&(A(H),A(Q)),el.current===l&&(A(el),ve._currentValue=G)}var Va,yu;function Mn(l){if(Va===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);Va=t&&t[1]||"",yu=-1<n.stack.indexOf(`
...
<p><strong>Символика:</strong> Сомбреро стало символом Мексики (иногда стереотипным). Но для мексиканцев это часть национального костюма и гордости!</p>
  ...
  <img src="${u.frida1}" />
  <p><strong>Цитата:</strong> <em>"Я пишу себя, потому что я провожу много времени одна и потому что я — тема, которую знаю лучше всего."</em></p>
  ...
  <ol>
    ...
    <li>Фрида рисовала автопортреты - а ты сделай селфи)</li>
  </ol>
    `},{day:21,date:"2026-01-09",tanya_gift:"KopiCat Вьетнам",zebra_gift:"KopiCat Вьетнам (х2)",tanya_bonus:"Экзотический чай",zebra_bonus:"Экзотический чай (х2)",title:"День 20",tanya_message:"<p>Подарок: KopiCat Вьетнам</p><p>Бонус: Экзотический чай</p>",zebra_message:"<p>Подарок: KopiCat Вьетнам (х2)</p><p>Бонус: Экзотический чай (х2)</p>"},{day:22,date:"2026-01-10",tanya_gift:"Армянский 3в1",zebra_gift:"Армянский 3в1 (х2)",tanya_bonus:"Миндальный Вкусвилл",zebra_bonus:"Миндальный Вкусвилл (х2)",title:"День 21",tanya_message:"<p>Подарок: Армянский 3в1</p><p>Бонус: Миндальный Вкусвилл</p>",zebra_message:"<p>Подарок: Армянский 3в1 (х2)</p><p>Бонус: Миндальный Вкусвилл (х2)</p>"},{day:23,date:"2026-01-11",tanya_gift:"Декаф Питерский",zebra_gift:"Декаф IL DA DA MA",tanya_bonus:"Чай-книга гаданий",zebra_bonus:"Чай-книга гаданий (х2)",title:"День 22",tanya_message:"<p>Подарок: Декаф Питерский</p><p>Бонус: Чай-книга гаданий</p>",zebra_message:"<p>Подарок: Декаф IL DA DA MA</p><p>Бонус: Чай-книга гаданий (х2)</p>"},{day:24,date:"2026-01-12",tanya_gift:"Декаф Гватемала",zebra_gift:"Декаф Мексика (х2)",tanya_bonus:"Бэггинс кофе",zebra_bonus:"Бэггинс кофе (х2)",title:"День 23",tanya_message:"<p>Подарок: Декаф Гватемала</p><p>Бонус: Бэггинс кофе</p>",zebra_message:"<p>Подарок: Декаф Мексика (х2)</p><p>Бонус: Бэггинс кофе (х2)</p>"},{day:25,date:"2026-01-13",tanya_gift:"Рождественский с лошадью",zebra_gift:"Рождественский с лошадью (х2)",tanya_bonus:"Какао с опоссумом",zebra_bonus:"Какао с опоссумом (х2)",title:"День 24",tanya_message:"<p>Подарок: Рождественский с лошадью</p><p>Бонус: Какао с опоссумом</p>",zebra_message:"<p>Подарок: Рождественский с лошадью (х2)</p><p>Бонус: Какао с опоссумом (х2)</p>"},{day:26,date:"2026-01-14",tanya_gift:"Иисус любит тебя",zebra_gift:"Эфиопия Гуджи (х2)",tanya_bonus:"Бразилия Фенси",zebra_bonus:"Бразилия Фенси (х2)",title:"День 25",tanya_message:"<p>Подарок: Иисус любит тебя</p><p>Бонус: Бразилия Фенси</p>",zebra_message:"<p>Подарок: Эфиопия Гуджи (х2)</p><p>Бонус: Бразилия Фенси (х2)</p>"}];function py({currentDate:v,userName:j}){const[O,p]=zl.useState(()=>Yf()),[M,x]=zl.useState(null),X=E=>{const N=La(E);if(Qa(N,v)&&(x(E),!O.has(E))){const $=qm(E);p($)}},P=()=>{x(null)},T=[...Array.from({length:25},(E,N)=>N+1)].sort((E,N)=>{const $=La(E),yl=La(N),vl=mu($,v),_l=mu(yl,v),Ul=O.has(E),bl=O.has(N),Ml=Qa($,v),ol=Qa(yl,v),Tl=Ml&&!Ul,Vl=ol&&!bl,Sl=vl&&Ul,K=_l&&bl,Hl=!Ml,Jl=!ol,Ft=Ul&&!vl&&Ml,pt=bl&&!_l&&ol;return Tl&&!Vl?-1:!Tl&&Vl?1:Tl&&Vl?E-N:Sl&&!K?-1:!Sl&&K?1:Hl&&!Jl?-1:!Hl&&Jl?1:Hl&&Jl||Ft&&pt?E-N:0});return d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"calendar-grid",children:T.map(E=>{const N=La(E),$=Qa(N,v),yl=O.has(E),vl=mu(N,v);return d.jsx(Wm,{windowNumber:E,isActive:$,isOpened:yl,isExactMatch:vl,onClick:()=>X(E)},E)})}),M!==null&&(()=>{const E=fy[M-1],N=j==="Tanya"?E.tanya_message:j==="Zebra"?E.zebra_message:"<p>Тут ничего нет.</p> <p>Никаких секретных посланий</p>";return d.jsx(Fm,{windowNumber:M,message:N,onClose:P})})()]})}function dy(){const[v,j]=zl.useState(!1),O=zl.useRef(null),[p,M]=zl.useState(!1);zl.useEffect(()=>{const X=localStorage.getItem("musicEnabled");console.debug("[AudioControls] mount - musicPref=",X),X==="true"&&(console.debug("[AudioControls] stored preference requests autoplay but user gesture required"),M(!0))},[]),zl.useEffect(()=>{if(!p)return;const X=()=>{console.debug("[AudioControls] user gesture detected, starting audio"),j(!0),M(!1),window.removeEventListener("pointerdown",X),window.removeEventListener("keydown",X)};return window.addEventListener("pointerdown",X,{once:!0}),window.addEventListener("keydown",X,{once:!0}),()=>{window.removeEventListener("pointerdown",X),window.removeEventListener("keydown",X)}},[p]),zl.useEffect(()=>{if(console.debug("[AudioControls] effect isMusicPlaying=",v,"ref=",O.current),!O.current)return;const X=O.current;if(v)console.debug("[AudioControls] calling play()"),X.play().then(()=>console.debug("[AudioControls] play() fulfilled")).catch(P=>{console.error("[AudioControls] Music play failed:",P),P&&P.name==="NotAllowedError"&&(console.debug("[AudioControls] play blocked; awaiting user gesture to resume"),M(!0))});else{console.debug("[AudioControls] calling pause()");try{X.pause()}catch(P){console.error("[AudioControls] pause() failed:",P)}}},[v]);const x=()=>{const X=!v;console.debug("[AudioControls] toggleMusic ->",X),j(X),localStorage.setItem("musicEnabled",String(X))};return d.jsxs("div",{className:"audio-controls",children:[d.jsxs("button",{className:`audio-button ${v?"audio-active":""}`,onClick:x,title:"Toggle Christmas Music",children:[v?d.jsx(Bm,{size:20}):d.jsx(Rm,{size:20}),d.jsx(Om,{size:16,className:"audio-icon-secondary"})]}),d.jsx("audio",{ref:O,loop:!0,preload:"auto",src:"audio/Frost_Waltz.mp3",onCanPlay:()=>console.debug("[AudioControls] audio canplay"),onPlay:()=>console.debug("[AudioControls] audio event: play"),onPause:()=>console.debug("[AudioControls] audio event: pause"),onError:X=>console.error("[AudioControls] audio event: error",X)})]})}function my(){return d.jsx("div",{className:"snowfall",children:Array.from({length:100}).map((v,j)=>d.jsx("div",{className:"snowflake",style:{left:`${Math.random()*100}%`,animationDuration:`${Math.random()*8+10}s`,animationDelay:`${Math.random()*8}s`,width:`${Math.random()*6+4}px`,height:`${Math.random()*6+4}px`}},j))})}const hy=()=>new Date;function yy(){const[v,j]=zl.useState(()=>{const x=localStorage.getItem("adventCalendarUser");return x==="Tanya"||x==="Zebra"?x:(localStorage.clear(),null)}),[O,p]=zl.useState(hy),M=x=>{localStorage.clear(),j(x),localStorage.setItem("adventCalendarUser",x)};return zl.useEffect(()=>{(async()=>{try{const P=await(await fetch("https://worldtimeapi.org/api/ip")).json(),U=new Date(P.datetime);p(U)}catch(X){console.error("Failed to fetch current date:",X),p(new Date)}})()},[]),d.jsxs("div",{className:"app-container",children:[d.jsx(Qm,{}),d.jsx(my,{}),d.jsx(dy,{}),d.jsxs("div",{className:"content-wrapper",children:[d.jsx(Lm,{userName:v,onUserSelect:M}),d.jsx(py,{currentDate:O,userName:v})]})]})}vm.createRoot(document.getElementById("root")).render(d.jsx(zl.StrictMode,{children:d.jsx(yy,{})}));
