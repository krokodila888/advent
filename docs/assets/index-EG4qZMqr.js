(function(){const M=document.createElement("link").relList;if(M&&M.supports&&M.supports("modulepreload"))return;for(const A of document.querySelectorAll('link[rel="modulepreload"]'))f(A);new MutationObserver(A=>{for(const x of A)if(x.type==="childList")for(const Y of x.addedNodes)Y.tagName==="LINK"&&Y.rel==="modulepreload"&&f(Y)}).observe(document,{childList:!0,subtree:!0});function O(A){const x={};return A.integrity&&(x.integrity=A.integrity),A.referrerPolicy&&(x.referrerPolicy=A.referrerPolicy),A.crossOrigin==="use-credentials"?x.credentials="include":A.crossOrigin==="anonymous"?x.credentials="omit":x.credentials="same-origin",x}function f(A){if(A.ep)return;A.ep=!0;const x=O(A);fetch(A.href,x)}})();var ur={exports:{}},zn={};var bp;function um(){if(bp)return zn;bp=1;var b=Symbol.for("react.transitional.element"),M=Symbol.for("react.fragment");function O(f,A,x){var Y=null;if(x!==void 0&&(Y=""+x),A.key!==void 0&&(Y=""+A.key),"key"in A){x={};for(var P in A)P!=="key"&&(x[P]=A[P])}else x=A;return A=x.ref,{$$typeof:b,type:f,key:Y,ref:A!==void 0?A:null,props:x}}return zn.Fragment=M,zn.jsx=O,zn.jsxs=O,zn}var vp;function gm(){return vp||(vp=1,ur.exports=um()),ur.exports}var d=gm(),gr={exports:{}},$={};var wp;function cm(){if(wp)return $;wp=1;var b=Symbol.for("react.transitional.element"),M=Symbol.for("react.portal"),O=Symbol.for("react.fragment"),f=Symbol.for("react.strict_mode"),A=Symbol.for("react.profiler"),x=Symbol.for("react.consumer"),Y=Symbol.for("react.context"),P=Symbol.for("react.forward_ref"),B=Symbol.for("react.suspense"),_=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),N=Symbol.for("react.activity"),Z=Symbol.iterator;function yl(c){return c===null||typeof c!="object"?null:(c=Z&&c[Z]||c["@@iterator"],typeof c=="function"?c:null)}var bl={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},zl=Object.assign,Bl={};function vl(c,j,D){this.props=c,this.context=j,this.refs=Bl,this.updater=D||bl}vl.prototype.isReactComponent={},vl.prototype.setState=function(c,j){if(typeof c!="object"&&typeof c!="function"&&c!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,c,j,"setState")},vl.prototype.forceUpdate=function(c){this.updater.enqueueForceUpdate(this,c,"forceUpdate")};function Al(){}Al.prototype=vl.prototype;function ol(c,j,D){this.props=c,this.context=j,this.refs=Bl,this.updater=D||bl}var _l=ol.prototype=new Al;_l.constructor=ol,zl(_l,vl.prototype),_l.isPureReactComponent=!0;var Ql=Array.isArray;function wl(){}var V={H:null,A:null,T:null,S:null},Rl=Object.prototype.hasOwnProperty;function Kl(c,j,D){var R=D.ref;return{$$typeof:b,type:c,key:j,ref:R!==void 0?R:null,props:D}}function Ft(c,j){return Kl(c.type,j,c.props)}function ft(c){return typeof c=="object"&&c!==null&&c.$$typeof===b}function Jl(c){var j={"=":"=0",":":"=2"};return"$"+c.replace(/[=:]/g,function(D){return j[D]})}var Ti=/\/+/g;function xt(c,j){return typeof c=="object"&&c!==null&&c.key!=null?Jl(""+c.key):j.toString(36)}function Tt(c){switch(c.status){case"fulfilled":return c.value;case"rejected":throw c.reason;default:switch(typeof c.status=="string"?c.then(wl,wl):(c.status="pending",c.then(function(j){c.status==="pending"&&(c.status="fulfilled",c.value=j)},function(j){c.status==="pending"&&(c.status="rejected",c.reason=j)})),c.status){case"fulfilled":return c.value;case"rejected":throw c.reason}}throw c}function S(c,j,D,R,L){var K=typeof c;(K==="undefined"||K==="boolean")&&(c=null);var nl=!1;if(c===null)nl=!0;else switch(K){case"bigint":case"string":case"number":nl=!0;break;case"object":switch(c.$$typeof){case b:case M:nl=!0;break;case E:return nl=c._init,S(nl(c._payload),j,D,R,L)}}if(nl)return L=L(c),nl=R===""?"."+xt(c,0):R,Ql(L)?(D="",nl!=null&&(D=nl.replace(Ti,"$&/")+"/"),S(L,j,D,"",function(Ce){return Ce})):L!=null&&(ft(L)&&(L=Ft(L,D+(L.key==null||c&&c.key===L.key?"":(""+L.key).replace(Ti,"$&/")+"/")+nl)),j.push(L)),1;nl=0;var Zl=R===""?".":R+":";if(Ql(c))for(var Ml=0;Ml<c.length;Ml++)R=c[Ml],K=Zl+xt(R,Ml),nl+=S(R,j,D,K,L);else if(Ml=yl(c),typeof Ml=="function")for(c=Ml.call(c),Ml=0;!(R=c.next()).done;)R=R.value,K=Zl+xt(R,Ml++),nl+=S(R,j,D,K,L);else if(K==="object"){if(typeof c.then=="function")return S(Tt(c),j,D,R,L);throw j=String(c),Error("Objects are not valid as a React child (found: "+(j==="[object Object]"?"object with keys {"+Object.keys(c).join(", ")+"}":j)+"). If you meant to render a collection of children, use an array instead.")}return nl}function C(c,j,D){if(c==null)return c;var R=[],L=0;return S(c,R,"","",function(K){return j.call(D,K,L++)}),R}function G(c){if(c._status===-1){var j=c._result;j=j(),j.then(function(D){(c._status===0||c._status===-1)&&(c._status=1,c._result=D)},function(D){(c._status===0||c._status===-1)&&(c._status=2,c._result=D)}),c._status===-1&&(c._status=0,c._result=j)}if(c._status===1)return c._result.default;throw c._result}var rl=typeof reportError=="function"?reportError:function(c){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var j=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof c=="object"&&c!==null&&typeof c.message=="string"?String(c.message):String(c),error:c});if(!window.dispatchEvent(j))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",c);return}console.error(c)},pl={map:C,forEach:function(c,j,D){C(c,function(){j.apply(this,arguments)},D)},count:function(c){var j=0;return C(c,function(){j++}),j},toArray:function(c){return C(c,function(j){return j})||[]},only:function(c){if(!ft(c))throw Error("React.Children.only expected to receive a single React element child.");return c}};return $.Activity=N,$.Children=pl,$.Component=vl,$.Fragment=O,$.Profiler=A,$.PureComponent=ol,$.StrictMode=f,$.Suspense=B,$.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=V,$.__COMPILER_RUNTIME={__proto__:null,c:function(c){return V.H.useMemoCache(c)}},$.cache=function(c){return function(){return c.apply(null,arguments)}},$.cacheSignal=function(){return null},$.cloneElement=function(c,j,D){if(c==null)throw Error("The argument must be a React element, but you passed "+c+".");var R=zl({},c.props),L=c.key;if(j!=null)for(K in j.key!==void 0&&(L=""+j.key),j)!Rl.call(j,K)||K==="key"||K==="__self"||K==="__source"||K==="ref"&&j.ref===void 0||(R[K]=j[K]);var K=arguments.length-2;if(K===1)R.children=D;else if(1<K){for(var nl=Array(K),Zl=0;Zl<K;Zl++)nl[Zl]=arguments[Zl+2];R.children=nl}return Kl(c.type,L,R)},$.createContext=function(c){return c={$$typeof:Y,_currentValue:c,_currentValue2:c,_threadCount:0,Provider:null,Consumer:null},c.Provider=c,c.Consumer={$$typeof:x,_context:c},c},$.createElement=function(c,j,D){var R,L={},K=null;if(j!=null)for(R in j.key!==void 0&&(K=""+j.key),j)Rl.call(j,R)&&R!=="key"&&R!=="__self"&&R!=="__source"&&(L[R]=j[R]);var nl=arguments.length-2;if(nl===1)L.children=D;else if(1<nl){for(var Zl=Array(nl),Ml=0;Ml<nl;Ml++)Zl[Ml]=arguments[Ml+2];L.children=Zl}if(c&&c.defaultProps)for(R in nl=c.defaultProps,nl)L[R]===void 0&&(L[R]=nl[R]);return Kl(c,K,L)},$.createRef=function(){return{current:null}},$.forwardRef=function(c){return{$$typeof:P,render:c}},$.isValidElement=ft,$.lazy=function(c){return{$$typeof:E,_payload:{_status:-1,_result:c},_init:G}},$.memo=function(c,j){return{$$typeof:_,type:c,compare:j===void 0?null:j}},$.startTransition=function(c){var j=V.T,D={};V.T=D;try{var R=c(),L=V.S;L!==null&&L(D,R),typeof R=="object"&&R!==null&&typeof R.then=="function"&&R.then(wl,rl)}catch(K){rl(K)}finally{j!==null&&D.types!==null&&(j.types=D.types),V.T=j}},$.unstable_useCacheRefresh=function(){return V.H.useCacheRefresh()},$.use=function(c){return V.H.use(c)},$.useActionState=function(c,j,D){return V.H.useActionState(c,j,D)},$.useCallback=function(c,j){return V.H.useCallback(c,j)},$.useContext=function(c){return V.H.useContext(c)},$.useDebugValue=function(){},$.useDeferredValue=function(c,j){return V.H.useDeferredValue(c,j)},$.useEffect=function(c,j){return V.H.useEffect(c,j)},$.useEffectEvent=function(c){return V.H.useEffectEvent(c)},$.useId=function(){return V.H.useId()},$.useImperativeHandle=function(c,j,D){return V.H.useImperativeHandle(c,j,D)},$.useInsertionEffect=function(c,j){return V.H.useInsertionEffect(c,j)},$.useLayoutEffect=function(c,j){return V.H.useLayoutEffect(c,j)},$.useMemo=function(c,j){return V.H.useMemo(c,j)},$.useOptimistic=function(c,j){return V.H.useOptimistic(c,j)},$.useReducer=function(c,j,D){return V.H.useReducer(c,j,D)},$.useRef=function(c){return V.H.useRef(c)},$.useState=function(c){return V.H.useState(c)},$.useSyncExternalStore=function(c,j,D){return V.H.useSyncExternalStore(c,j,D)},$.useTransition=function(){return V.H.useTransition()},$.version="19.2.3",$}var Sp;function hr(){return Sp||(Sp=1,gr.exports=cm()),gr.exports}var Sl=hr(),cr={exports:{}},_n={},pr={exports:{}},fr={};var zp;function pm(){return zp||(zp=1,(function(b){function M(S,C){var G=S.length;S.push(C);l:for(;0<G;){var rl=G-1>>>1,pl=S[rl];if(0<A(pl,C))S[rl]=C,S[G]=pl,G=rl;else break l}}function O(S){return S.length===0?null:S[0]}function f(S){if(S.length===0)return null;var C=S[0],G=S.pop();if(G!==C){S[0]=G;l:for(var rl=0,pl=S.length,c=pl>>>1;rl<c;){var j=2*(rl+1)-1,D=S[j],R=j+1,L=S[R];if(0>A(D,G))R<pl&&0>A(L,D)?(S[rl]=L,S[R]=G,rl=R):(S[rl]=D,S[j]=G,rl=j);else if(R<pl&&0>A(L,G))S[rl]=L,S[R]=G,rl=R;else break l}}return C}function A(S,C){var G=S.sortIndex-C.sortIndex;return G!==0?G:S.id-C.id}if(b.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var x=performance;b.unstable_now=function(){return x.now()}}else{var Y=Date,P=Y.now();b.unstable_now=function(){return Y.now()-P}}var B=[],_=[],E=1,N=null,Z=3,yl=!1,bl=!1,zl=!1,Bl=!1,vl=typeof setTimeout=="function"?setTimeout:null,Al=typeof clearTimeout=="function"?clearTimeout:null,ol=typeof setImmediate<"u"?setImmediate:null;function _l(S){for(var C=O(_);C!==null;){if(C.callback===null)f(_);else if(C.startTime<=S)f(_),C.sortIndex=C.expirationTime,M(B,C);else break;C=O(_)}}function Ql(S){if(zl=!1,_l(S),!bl)if(O(B)!==null)bl=!0,wl||(wl=!0,Jl());else{var C=O(_);C!==null&&Tt(Ql,C.startTime-S)}}var wl=!1,V=-1,Rl=5,Kl=-1;function Ft(){return Bl?!0:!(b.unstable_now()-Kl<Rl)}function ft(){if(Bl=!1,wl){var S=b.unstable_now();Kl=S;var C=!0;try{l:{bl=!1,zl&&(zl=!1,Al(V),V=-1),yl=!0;var G=Z;try{t:{for(_l(S),N=O(B);N!==null&&!(N.expirationTime>S&&Ft());){var rl=N.callback;if(typeof rl=="function"){N.callback=null,Z=N.priorityLevel;var pl=rl(N.expirationTime<=S);if(S=b.unstable_now(),typeof pl=="function"){N.callback=pl,_l(S),C=!0;break t}N===O(B)&&f(B),_l(S)}else f(B);N=O(B)}if(N!==null)C=!0;else{var c=O(_);c!==null&&Tt(Ql,c.startTime-S),C=!1}}break l}finally{N=null,Z=G,yl=!1}C=void 0}}finally{C?Jl():wl=!1}}}var Jl;if(typeof ol=="function")Jl=function(){ol(ft)};else if(typeof MessageChannel<"u"){var Ti=new MessageChannel,xt=Ti.port2;Ti.port1.onmessage=ft,Jl=function(){xt.postMessage(null)}}else Jl=function(){vl(ft,0)};function Tt(S,C){V=vl(function(){S(b.unstable_now())},C)}b.unstable_IdlePriority=5,b.unstable_ImmediatePriority=1,b.unstable_LowPriority=4,b.unstable_NormalPriority=3,b.unstable_Profiling=null,b.unstable_UserBlockingPriority=2,b.unstable_cancelCallback=function(S){S.callback=null},b.unstable_forceFrameRate=function(S){0>S||125<S?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Rl=0<S?Math.floor(1e3/S):5},b.unstable_getCurrentPriorityLevel=function(){return Z},b.unstable_next=function(S){switch(Z){case 1:case 2:case 3:var C=3;break;default:C=Z}var G=Z;Z=C;try{return S()}finally{Z=G}},b.unstable_requestPaint=function(){Bl=!0},b.unstable_runWithPriority=function(S,C){switch(S){case 1:case 2:case 3:case 4:case 5:break;default:S=3}var G=Z;Z=S;try{return C()}finally{Z=G}},b.unstable_scheduleCallback=function(S,C,G){var rl=b.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?rl+G:rl):G=rl,S){case 1:var pl=-1;break;case 2:pl=250;break;case 5:pl=1073741823;break;case 4:pl=1e4;break;default:pl=5e3}return pl=G+pl,S={id:E++,callback:C,priorityLevel:S,startTime:G,expirationTime:pl,sortIndex:-1},G>rl?(S.sortIndex=G,M(_,S),O(B)===null&&S===O(_)&&(zl?(Al(V),V=-1):zl=!0,Tt(Ql,G-rl))):(S.sortIndex=pl,M(B,S),bl||yl||(bl=!0,wl||(wl=!0,Jl()))),S},b.unstable_shouldYield=Ft,b.unstable_wrapCallback=function(S){var C=Z;return function(){var G=Z;Z=C;try{return S.apply(this,arguments)}finally{Z=G}}}})(fr)),fr}var _p;function fm(){return _p||(_p=1,pr.exports=pm()),pr.exports}var dr={exports:{}},kl={};var Tp;function dm(){if(Tp)return kl;Tp=1;var b=hr();function M(B){var _="https://react.dev/errors/"+B;if(1<arguments.length){_+="?args[]="+encodeURIComponent(arguments[1]);for(var E=2;E<arguments.length;E++)_+="&args[]="+encodeURIComponent(arguments[E])}return"Minified React error #"+B+"; visit "+_+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function O(){}var f={d:{f:O,r:function(){throw Error(M(522))},D:O,C:O,L:O,m:O,X:O,S:O,M:O},p:0,findDOMNode:null},A=Symbol.for("react.portal");function x(B,_,E){var N=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:A,key:N==null?null:""+N,children:B,containerInfo:_,implementation:E}}var Y=b.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function P(B,_){if(B==="font")return"";if(typeof _=="string")return _==="use-credentials"?_:""}return kl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=f,kl.createPortal=function(B,_){var E=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!_||_.nodeType!==1&&_.nodeType!==9&&_.nodeType!==11)throw Error(M(299));return x(B,_,null,E)},kl.flushSync=function(B){var _=Y.T,E=f.p;try{if(Y.T=null,f.p=2,B)return B()}finally{Y.T=_,f.p=E,f.d.f()}},kl.preconnect=function(B,_){typeof B=="string"&&(_?(_=_.crossOrigin,_=typeof _=="string"?_==="use-credentials"?_:"":void 0):_=null,f.d.C(B,_))},kl.prefetchDNS=function(B){typeof B=="string"&&f.d.D(B)},kl.preinit=function(B,_){if(typeof B=="string"&&_&&typeof _.as=="string"){var E=_.as,N=P(E,_.crossOrigin),Z=typeof _.integrity=="string"?_.integrity:void 0,yl=typeof _.fetchPriority=="string"?_.fetchPriority:void 0;E==="style"?f.d.S(B,typeof _.precedence=="string"?_.precedence:void 0,{crossOrigin:N,integrity:Z,fetchPriority:yl}):E==="script"&&f.d.X(B,{crossOrigin:N,integrity:Z,fetchPriority:yl,nonce:typeof _.nonce=="string"?_.nonce:void 0})}},kl.preinitModule=function(B,_){if(typeof B=="string")if(typeof _=="object"&&_!==null){if(_.as==null||_.as==="script"){var E=P(_.as,_.crossOrigin);f.d.M(B,{crossOrigin:E,integrity:typeof _.integrity=="string"?_.integrity:void 0,nonce:typeof _.nonce=="string"?_.nonce:void 0})}}else _==null&&f.d.M(B)},kl.preload=function(B,_){if(typeof B=="string"&&typeof _=="object"&&_!==null&&typeof _.as=="string"){var E=_.as,N=P(E,_.crossOrigin);f.d.L(B,E,{crossOrigin:N,integrity:typeof _.integrity=="string"?_.integrity:void 0,nonce:typeof _.nonce=="string"?_.nonce:void 0,type:typeof _.type=="string"?_.type:void 0,fetchPriority:typeof _.fetchPriority=="string"?_.fetchPriority:void 0,referrerPolicy:typeof _.referrerPolicy=="string"?_.referrerPolicy:void 0,imageSrcSet:typeof _.imageSrcSet=="string"?_.imageSrcSet:void 0,imageSizes:typeof _.imageSizes=="string"?_.imageSizes:void 0,media:typeof _.media=="string"?_.media:void 0})}},kl.preloadModule=function(B,_){if(typeof B=="string")if(_){var E=P(_.as,_.crossOrigin);f.d.m(B,{as:typeof _.as=="string"&&_.as!=="script"?_.as:void 0,crossOrigin:E,integrity:typeof _.integrity=="string"?_.integrity:void 0})}else f.d.m(B)},kl.requestFormReset=function(B){f.d.r(B)},kl.unstable_batchedUpdates=function(B,_){return B(_)},kl.useFormState=function(B,_,E){return Y.H.useFormState(B,_,E)},kl.useFormStatus=function(){return Y.H.useHostTransitionStatus()},kl.version="19.2.3",kl}var jp;function mm(){if(jp)return dr.exports;jp=1;function b(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(b)}catch(M){console.error(M)}}return b(),dr.exports=dm(),dr.exports}var Ap;function hm(){if(Ap)return _n;Ap=1;var b=fm(),M=hr(),O=mm();function f(l){var t="https://react.dev/errors/"+l;if(1<arguments.length){t+="?args[]="+encodeURIComponent(arguments[1]);for(var i=2;i<arguments.length;i++)t+="&args[]="+encodeURIComponent(arguments[i])}return"Minified React error #"+l+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function A(l){return!(!l||l.nodeType!==1&&l.nodeType!==9&&l.nodeType!==11)}function x(l){var t=l,i=l;if(l.alternate)for(;t.return;)t=t.return;else{l=t;do t=l,(t.flags&4098)!==0&&(i=t.return),l=t.return;while(l)}return t.tag===3?i:null}function Y(l){if(l.tag===13){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function P(l){if(l.tag===31){var t=l.memoizedState;if(t===null&&(l=l.alternate,l!==null&&(t=l.memoizedState)),t!==null)return t.dehydrated}return null}function B(l){if(x(l)!==l)throw Error(f(188))}function _(l){var t=l.alternate;if(!t){if(t=x(l),t===null)throw Error(f(188));return t!==l?null:l}for(var i=l,e=t;;){var n=i.return;if(n===null)break;var a=n.alternate;if(a===null){if(e=n.return,e!==null){i=e;continue}break}if(n.child===a.child){for(a=n.child;a;){if(a===i)return B(n),l;if(a===e)return B(n),t;a=a.sibling}throw Error(f(188))}if(i.return!==e.return)i=n,e=a;else{for(var s=!1,r=n.child;r;){if(r===i){s=!0,i=n,e=a;break}if(r===e){s=!0,e=n,i=a;break}r=r.sibling}if(!s){for(r=a.child;r;){if(r===i){s=!0,i=a,e=n;break}if(r===e){s=!0,e=a,i=n;break}r=r.sibling}if(!s)throw Error(f(189))}}if(i.alternate!==e)throw Error(f(190))}if(i.tag!==3)throw Error(f(188));return i.stateNode.current===i?l:t}function E(l){var t=l.tag;if(t===5||t===26||t===27||t===6)return l;for(l=l.child;l!==null;){if(t=E(l),t!==null)return t;l=l.sibling}return null}var N=Object.assign,Z=Symbol.for("react.element"),yl=Symbol.for("react.transitional.element"),bl=Symbol.for("react.portal"),zl=Symbol.for("react.fragment"),Bl=Symbol.for("react.strict_mode"),vl=Symbol.for("react.profiler"),Al=Symbol.for("react.consumer"),ol=Symbol.for("react.context"),_l=Symbol.for("react.forward_ref"),Ql=Symbol.for("react.suspense"),wl=Symbol.for("react.suspense_list"),V=Symbol.for("react.memo"),Rl=Symbol.for("react.lazy"),Kl=Symbol.for("react.activity"),Ft=Symbol.for("react.memo_cache_sentinel"),ft=Symbol.iterator;function Jl(l){return l===null||typeof l!="object"?null:(l=ft&&l[ft]||l["@@iterator"],typeof l=="function"?l:null)}var Ti=Symbol.for("react.client.reference");function xt(l){if(l==null)return null;if(typeof l=="function")return l.$$typeof===Ti?null:l.displayName||l.name||null;if(typeof l=="string")return l;switch(l){case zl:return"Fragment";case vl:return"Profiler";case Bl:return"StrictMode";case Ql:return"Suspense";case wl:return"SuspenseList";case Kl:return"Activity"}if(typeof l=="object")switch(l.$$typeof){case bl:return"Portal";case ol:return l.displayName||"Context";case Al:return(l._context.displayName||"Context")+".Consumer";case _l:var t=l.render;return l=l.displayName,l||(l=t.displayName||t.name||"",l=l!==""?"ForwardRef("+l+")":"ForwardRef"),l;case V:return t=l.displayName||null,t!==null?t:xt(l.type)||"Memo";case Rl:t=l._payload,l=l._init;try{return xt(l(t))}catch{}}return null}var Tt=Array.isArray,S=M.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,C=O.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,G={pending:!1,data:null,method:null,action:null},rl=[],pl=-1;function c(l){return{current:l}}function j(l){0>pl||(l.current=rl[pl],rl[pl]=null,pl--)}function D(l,t){pl++,rl[pl]=l.current,l.current=t}var R=c(null),L=c(null),K=c(null),nl=c(null);function Zl(l,t){switch(D(K,t),D(L,l),D(R,null),t.nodeType){case 9:case 11:l=(l=t.documentElement)&&(l=l.namespaceURI)?Gc(l):0;break;default:if(l=t.tagName,t=t.namespaceURI)t=Gc(t),l=$c(t,l);else switch(l){case"svg":l=1;break;case"math":l=2;break;default:l=0}}j(R),D(R,l)}function Ml(){j(R),j(L),j(K)}function Ce(l){l.memoizedState!==null&&D(nl,l);var t=R.current,i=$c(t,l.type);t!==i&&(D(L,l),D(R,i))}function Tn(l){L.current===l&&(j(R),j(L)),nl.current===l&&(j(nl),bn._currentValue=G)}var Qa,yr;function ji(l){if(Qa===void 0)try{throw Error()}catch(i){var t=i.stack.trim().match(/\n( *(at )?)/);Qa=t&&t[1]||"",yr=-1<i.stack.indexOf(`
...
<p>Ну и какого-нибудь классического звукового сопровождения тебе в ленту:</p>
    <iframe width="100%"src="https://www.youtube.com/embed/0hfOyOBHIq4?si=fMvObxRyhA33eO3o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`}];function ob({currentDate:b,userName:M}){const[O,f]=Sl.useState(()=>Yp()),[A,x]=Sl.useState(null),Y=E=>{const N=$a(E);if(La(N,b)&&(x(E),!O.has(E))){const Z=Xm(E);f(Z)}},P=()=>{x(null)},_=[...Array.from({length:38},(E,N)=>N+1)].sort((E,N)=>{const Z=$a(E),yl=$a(N),bl=mr(Z,b),zl=mr(yl,b),Bl=O.has(E),vl=O.has(N),Al=La(Z,b),ol=La(yl,b),_l=Al&&!Bl,Ql=ol&&!vl,wl=bl&&Bl,V=zl&&vl,Rl=!Al,Kl=!ol,Ft=Bl&&!bl&&Al,ft=vl&&!zl&&ol;return _l&&!Ql?-1:!_l&&Ql?1:_l&&Ql?E-N:wl&&!V?-1:!wl&&V?1:Rl&&!Kl?-1:!Rl&&Kl?1:Rl&&Kl||Ft&&ft?E-N:0});return d.jsxs(d.Fragment,{children:[d.jsx("div",{className:"calendar-grid",children:_.map(E=>{const N=$a(E),Z=La(N,b),yl=O.has(E),bl=mr(N,b);return d.jsx(Wm,{windowNumber:E,isActive:Z,isOpened:yl,isExactMatch:bl,onClick:()=>Y(E)},E)})}),A!==null&&(()=>{const E=sb[A-1],N=M==="Tanya"?E.tanya_message:M==="Zebra"?E.zebra_message:"<p>Тут ничего нет.</p> <p>Никаких секретных посланий</p>";return d.jsx(Fm,{windowNumber:A,message:N,onClose:P})})()]})}function rb(){const[b,M]=Sl.useState(!1),O=Sl.useRef(null),[f,A]=Sl.useState(!1);Sl.useEffect(()=>{const Y=localStorage.getItem("musicEnabled");console.debug("[AudioControls] mount - musicPref=",Y),Y==="true"&&(console.debug("[AudioControls] stored preference requests autoplay but user gesture required"),A(!0))},[]),Sl.useEffect(()=>{if(!f)return;const Y=()=>{console.debug("[AudioControls] user gesture detected, starting audio"),M(!0),A(!1),window.removeEventListener("pointerdown",Y),window.removeEventListener("keydown",Y)};return window.addEventListener("pointerdown",Y,{once:!0}),window.addEventListener("keydown",Y,{once:!0}),()=>{window.removeEventListener("pointerdown",Y),window.removeEventListener("keydown",Y)}},[f]),Sl.useEffect(()=>{if(console.debug("[AudioControls] effect isMusicPlaying=",b,"ref=",O.current),!O.current)return;const Y=O.current;if(b)console.debug("[AudioControls] calling play()"),Y.play().then(()=>console.debug("[AudioControls] play() fulfilled")).catch(P=>{console.error("[AudioControls] Music play failed:",P),P&&P.name==="NotAllowedError"&&(console.debug("[AudioControls] play blocked; awaiting user gesture to resume"),A(!0))});else{console.debug("[AudioControls] calling pause()");try{Y.pause()}catch(P){console.error("[AudioControls] pause() failed:",P)}}},[b]);const x=()=>{const Y=!b;console.debug("[AudioControls] toggleMusic ->",Y),M(Y),localStorage.setItem("musicEnabled",String(Y))};return d.jsxs("div",{className:"audio-controls",children:[d.jsxs("button",{className:`audio-button ${b?"audio-active":""}`,onClick:x,title:"Toggle Christmas Music",children:[b?d.jsx(Um,{size:20}):d.jsx(Hm,{size:20}),d.jsx(Om,{size:16,className:"audio-icon-secondary"})]}),d.jsx("audio",{ref:O,loop:!0,preload:"auto",src:"audio/Frost_Waltz.mp3",onCanPlay:()=>console.debug("[AudioControls] audio canplay"),onPlay:()=>console.debug("[AudioControls] audio event: play"),onPause:()=>console.debug("[AudioControls] audio event: pause"),onError:Y=>console.error("[AudioControls] audio event: error",Y)})]})}function ub(){return d.jsx("div",{className:"snowfall",children:Array.from({length:100}).map((b,M)=>d.jsx("div",{className:"snowflake",style:{left:`${Math.random()*100}%`,animationDuration:`${Math.random()*8+10}s`,animationDelay:`${Math.random()*8}s`,width:`${Math.random()*6+4}px`,height:`${Math.random()*6+4}px`}},M))})}const gb=()=>new Date;function cb(){const[b,M]=Sl.useState(()=>{const x=localStorage.getItem("adventCalendarUser");return x==="Tanya"||x==="Zebra"?x:(localStorage.clear(),null)}),[O,f]=Sl.useState(gb),A=x=>{localStorage.clear(),M(x),localStorage.setItem("adventCalendarUser",x)};return Sl.useEffect(()=>{(async()=>{try{const P=await(await fetch("https://worldtimeapi.org/api/ip")).json(),B=new Date(P.datetime);f(B)}catch(Y){console.error("Failed to fetch current date:",Y),f(new Date)}})()},[]),d.jsxs("div",{className:"app-container",children:[d.jsx(Lm,{}),d.jsx(ub,{}),d.jsx(rb,{}),d.jsxs("div",{className:"content-wrapper",children:[d.jsx($m,{userName:b,onUserSelect:A}),d.jsx(ob,{currentDate:O,userName:b})]})]})}bm.createRoot(document.getElementById("root")).render(d.jsx(Sl.StrictMode,{children:d.jsx(cb,{})}));
